...
optionspdd_line = {
            ...
            title: {
                useHTML: true,
                text: '<a href="https://tvscs.custhelp.com/app/dealer/dealer_disbursal_detail" id="linktopdd">Sales Performance Details In '+$("[id$=hfFirstYear]").val()+'</a>',
            },
            subtitle: {
                useHTML: true,
...
//alert(endDate);
	...
	//	var	chart_1 = getGraph('graph1','getSalesDisbursedCount');
     //   var  chart_2 = getGraph('graph2','getSalesPerformanceChartSummary');
     //   var chart_3 = getGraph('graph3','getPDDAgeingChartSummary');
       // var chart_4 = getGraph('graph4','getSalesPerformanceSummary');
			if(finalgraph == "sales_1"){
