        ...
        return this.each(function() {
            ...
            f.css({
                ...
                requredcontrol = !1, f.find(".sf-steps-form>ul").eq(t.active).find(":input").each(function() {
					...
					beforeSend: function() {
        // setting a timeout
						f.find('#loader').removeClass('loading');
					},
                    data: f.find("form").serialize()
                }).success(function(t) {
					f.find("#loader").addClass("hidden");
                                           
                        if(window.location.href.includes('dealer') == true){
                            //for dealer
                            if(t.Error_Msg == "Successfull"){  
                                window.location.href = '/app/dealer/new_lead_thanks/ref_id/'+t.InsertLMSDataNewResult;
                            }
                            else{
                                window.location.href = '/app/dealer/new_lead_thanks/err_msg/'+t.Error_Msg;
                            }
                        }
                        else{
                            //for emp portal
                            window.location.href = '/app/employee/new_lead_thanks/ref_id/'+t;
                        }
