...
class askEmployeeDealerCategory extends \Custom\Widgets\input\askDealerCategoryInput {
    ...
    function getData() {
		...
		$msg=\RightNow\Connect\v1_3\MessageBase::fetch(CUSTOM_MSG_EmpPortal_DealerHelpdesk);
		$report_id=$msg->Value;
