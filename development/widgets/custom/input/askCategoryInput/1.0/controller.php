...
class askCategoryInput extends \RightNow\Widgets\ProductCategoryInput
{
    ...
    function getData()
    {
        ...
        // $msg=\RightNow\Connect\v1_3\MessageBase::fetch(CUSTOM_MSG_Customer_Category);
        // $report_id=$msg->Value;
        $actual_link = "http://$_SERVER[HTTP_HOST]$_SERVER[REQUEST_URI]";
        if (stripos($actual_link, "msme") === false) {
            $msg = \RightNow\Connect\v1_3\MessageBase::fetch(CUSTOM_MSG_Customer_Category);
            $report_id = $msg->Value;
        } else {
            $msg = \RightNow\Connect\v1_3\MessageBase::fetch(CUSTOM_MSG_MSME_Category);
            $report_id = $msg->Value;
        }
        ...
        // echo "<pre>";
        // echo  $data['selected'];
        // echo ($hierData[1]['label']);/

        // echo ($hierData[1]['selected']);
