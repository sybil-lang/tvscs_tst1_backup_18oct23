...
class askEmployeeCategoryInput extends \Custom\Widgets\input\askCategoryInput {
    ...
    function getData() {
		...
		$msg=\RightNow\Connect\v1_3\MessageBase::fetch(CUSTOM_MSG_EmpPortal_CustomerHelpdesk);
		$report_id=$msg->Value;
