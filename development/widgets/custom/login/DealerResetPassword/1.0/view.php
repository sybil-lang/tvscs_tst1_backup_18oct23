<? /* Overriding ResetPassword's view */ ?>
<div id="rn_<?=$this->instanceID;?>" class="<?= $this->classList ?>">
    ...
    <?else:?>
        ...
        <rn:block id="postPasswordNew"/>
    <?endif;?>
    <rn:widget path="input/FormInput" name="Contact.CustomFields.c.custom_password" initial_focus="true" require_validation="true" label_input="#rn:msg:PASSWORD_LBL#" label_validation="#rn:msg:VERIFY_PASSWD_LBL#" sub_id="existingAccountPassword"/>
