RightNow.namespace('Custom.Widgets.login.dealerLogin');
Custom.Widgets.login.dealerLogin = RightNow.Widgets.extend({ 
    /**
     * Widget constructor.
     */
    ...
    _onLoginResponse: function(response, originalEventObject)
    {
        ...
        {
			$('.apollo-login').fadeIn(350, function(){
				$('.apollo-logging-in').fadeOut(350);
			});
    ...
    _onSubmit: function(e)
    {
        ...
        eventObject = new RightNow.Event.EventObject(this, {data: {
           login: username,
           //password: (( this._passwordField) ? this._passwordField.get("value") : ""),
