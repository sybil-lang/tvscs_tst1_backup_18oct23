...
function checkLoggedIn() {
	...
	if ( $Session_Contact_Id > 0 ) {
		...
		header( "Location: /app/employee/login" );
		exit;
	}
	...
	<div class="header-container">
		<div class="container">
			<div class="grid_12">
				...
				<div class="<?php echo ($Session_Contact_Id != " ")? 'grid_12' : 'grid_10';?>">
					<!--Change it to grid_12-->
					<div class="container">
						<div class="grid_10">
								...
								<ul>
									<li><a href="#" class="dropdown_bg"><img src="images/icons/dropdown-icon.png"> </a>
										...
										<ul>
											...
											<li><a href="#"><strong>Logout</strong></a>
											</li>
										</ul>
									</li>
								</ul>
			...
			<div class="container">
				<div class="<?php echo ($Session_Contact_Id != " ")? 'grid_12' : 'grid_11';?>">
					<!--Before login it would be grid_12-->
