...
<head>
  ...
  <rn:theme path="/euf/assets/themes/standard/css"
    css="site.css,style.css,style-product.css,styles.css,style-product.css,customerlogin-style.css" />
...
<body>
  ...
  <noscript><iframe src="https://www.googletagmanager.com/ns.html?id=GTM-KBWP7ZJ" height="0" width="0"
    ...
    <header id="header1">
      <div class="container1">
        ...
        <div id="logo" class="pull-left">
          <a class="" href="http://183.87.127.174:8787/"><img src="/euf/assets/themes/standard/Images-new/TVSCSlogo.png"
              alt="TVS Credits" /s></a>
        </div>
        <div class="pull-right login-search-panel">
          <ul class="nav-menu navbar-right primary-menu">
            ...
            <li class="dropdown search-slide">
              <div class="social-statuses"><span> </span><a href="https://www.facebook.com/TVSCREDIT" target="_blank"><i
                    class="fa fa-facebook  facebook"></i></a> <a href="https://twitter.com/TVSCredit" target="_blank"><i
                    class="fa fa-twitter twitter"></i></a> <a
                  href="https://www.linkedin.com/company-beta/1481214?pathWildcard=1481214" target="_blank"><i
            ...
            <li
              class="dropdown login-dropdown logins-dropdown hover-dropdown customermain_login  hidden-md visible-sm visible-xs">
              <a href="#" class="dropdown-toggle" data-toggle="dropdown" role="button" aria-haspopup="true"
                aria-expanded="false">
                <img src="/euf/assets/themes/standard/Images-new/dropdown icon.png" class="img-responsive hovers-back"
                  alt="dots">
                <img src="/euf/assets/themes/standard/Images-new/dropdown icons.png" class="img-responsive hovers-no"
                  alt="dots" style="display:none">
          ...
          <div class="col-md-2 col-xs-12 login">
            <div class="rn_LoginStatus">
              <rn:condition logged_in="true">
                ...
                <rn:widget path="custom/login/employeeAccountDropdown"
                  subpages="#rn:msg:ACCOUNT_OVERVIEW_LBL# > employee/account/overview, #rn:msg:SUPPORT_HISTORY_LBL# > employee/account/questions/list, #rn:msg:ACCOUNT_SETTINGS_LBL# > employee/account/profile" />
              </rn:condition>
            </div>
        ...
        <nav id="nav-menu-container" class="hidden-xs ">
          <div class="row">
            ...
            <div class="contact-info" id="mailid">
              <div class="contacts">
                <p> <img src="/euf/assets/themes/standard/Images-new/message-icon.png"><a
                    href="mailto:helpdesk@tvscredit.com">helpdesk@tvscredit.com</a></p>
              </div>
            </div>
  ...
  <rn:condition logged_in="true">
    <header>
      ...
      <?php } elseif (checkURL('customer')) { ?>
        <ul
          style="list-style: none;z-index: 10;float: right !important;margin-right: 14px !important;top:15px;position: relative;">
          <li>
            <a id="changecustomer" href="#" class="btn btn-warning btn-lg active" role="button" aria-pressed="true"
              style="font-size:13px;padding-top:0px;">Change Customer</a>
          </li>
        </ul>
      ...
      <div class="container-fluid">
        ...
        <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
          <ul class="nav navbar-nav" style="padding-top: 7px;">
            ...
            <li class="dropdown">
              <a href="#" class="dropdown-toggle" data-toggle="dropdown" role="button" aria-haspopup="true"
                aria-expanded="false"><i class="fa fa-tachometer" aria-hidden="true"></i>&nbsp;Dashboard <span
                  class="caret"></span></a>
              <ul class="dropdown-menu">
                <li><a href="<?php echo $site_url; ?>/app/employee/dashboard"><i class="fa fa-bar-chart"
                      aria-hidden="true"></i>&nbsp;Employee Dashboard</a></li>
                <li role="separator" class="divider"></li>
                <li><a href="<?php echo $site_url; ?>/app/employee/dealer/questions/list"><i class="fa fa-pie-chart"
                      aria-hidden="true"></i>&nbsp;Dealer Dashboard</a></li>
                <li role="separator" class="divider"></li>
                <li><a href="<?php echo $site_url; ?>/app/employee/customer/questions/list"><i class="fa fa-bar-chart"
                      aria-hidden="true"></i>&nbsp;Customer Dashboard</a></li>
                <!--							<li><a href="#">Something else here</a></li>
                                                                        <li><a href="#">Separated link</a></li>-->
              </ul>
            </li>
            <li>
              <a tabindex="-1" href="<?php echo $site_url; ?>/app/employee/dealerquery"><i class="fa fa-envelope"
                  aria-hidden="true"></i>&nbsp;Dealer Helpdesk</a>
              <!-- <a tabindex="-1" href="<?php echo $site_url; ?>/app/employee/dealerquery"><i class="fa fa-envelope" aria-hidden="true"></i>&nbsp;Dealer Helpdesk</a> -->
            </li>
            <li>
              <a tabindex="-1" href="<?php echo $site_url; ?>/app/employee/customer_dashboard"><i
                  class="fa fa-envelope-o" aria-hidden="true"></i>&nbsp;Customer Helpdesk</a>
            </li>
            <li class="lp-dropdown">
              <a href="#" class="dropdown-toggle" id="Agent-dropdown" data-toggle="dropdown" role="button"
                aria-haspopup="true" aria-expanded="false"><i class="fa fa-user" aria-hidden="true"></i>&nbsp;Leads
                <span class="caret"></span></a>
              <ul class="dropdown-menu" data-dropdown-owner="Agent-dropdown">
                <li>
                  <a tabindex="-1" href="<?php echo $site_url; ?>/app/employee/lead_generation"><i class="fa fa-plus"
                      aria-hidden="true"></i>&nbsp;Lead generation</a>
                </li>
                <li role="separator" class="divider"></li>
                <li>
                  <a tabindex="-1" href="<?php echo $site_url; ?>/app/employee/lead_status"><i class="fa fa-refresh"
                      aria-hidden="true"></i>&nbsp;Lead Status</a>
                </li>
                <li role="separator" class="divider"></li>
                <li>
                  <a tabindex="-1" href="<?php echo $site_url; ?>/app/employee/login_status"><i class="fa fa-lock"
                      aria-hidden="true"></i>&nbsp;Login Status</a>
                </li>
              </ul>
            </li>

            <li>
              <a href="<?php echo $site_url; ?>/app/employee/account/profile"><i class="fa fa-address-card"
            ...
            <li>
              <a href="<?php echo $site_url; ?>/app/employee/raisequery"><i class="fa fa-envelope"
                  aria-hidden="true"></i>&nbsp;Employee Helpdesk</a>
            </li>
            <?php if ($enable_walkin_customers) { ?>
              <li class="dropdown">
                ...
                <ul class="dropdown-menu">
                  <li>
                    <a href="<?php echo $site_url; ?>/app/employee/walkin_dashboard"><i
                        class="fa fa-male"></i>&nbsp;Walkin Dashboard</a>
                  </li>
                  <li>
