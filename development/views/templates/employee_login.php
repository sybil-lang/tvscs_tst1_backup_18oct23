...
<html lang="#rn:language_code#">
  ...
  <rn:theme path="/euf/assets/themes/standard/Css-new" css="site.css,style.css,style-product.css,styles.css,style-product.css,customerlogin-style.css"/>
 ...
 <link rel="icon" href="/euf/assets/images/icons/favicon.ico" type="image/ico">
  <rn:head_content/>
  ...
  <link rel="stylesheet" href="/euf/assets/themes/standard/Css-new/custom-style.css"/>
     <link rel="stylesheet" href="https://maxcdn.bootstrapcdn.com/bootstrap/3.3.7/css/bootstrap.min.css">
	  	<link rel="stylesheet" href="/euf/assets/themes/standard/Css-new/bootstrap-datetimepicker.min.css">
  ...
  <link rel="stylesheet" type="text/css" href="/euf/assets/themes/standard/Css-new/tautocomplete.css" />
  ...
  span.year:after,span.decade:after,span.month:after {
    ...
    background: #f00;
       ...
       @media screen and (max-width: 800px)
       {
           ...
           .custom_log .submit, .custom_log .submit:hover 
           {
...
<div class="row">
   <div class="col-md-offset-4 col-md-3">
			<!--	<div class="rn_ChatLink">
					<rn:widget path="chat/ConditionalChatLink" min_sessions_avail="1" chat_login_page="/app/chat/chat_launch" label_default="Our support team is available. Chat with our team and expect a quick reply." sub_id="conditionalChat"/>
				</div>-->
    </div>
    <div class="col-md-4">
