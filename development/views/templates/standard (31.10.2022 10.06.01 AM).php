												...
												$.post("/cc/AjaxCustom/InsuranceNotification", {
													...
													.done(function(data) {
														...
														if (data.includes('FIRSTNAME')) {
															...
															document.getElementById('notification-window').innerHTML += "<div class='notification-item-read'><h5 class='item-title'>Hi " + d[0]['FIRSTNAME'] + ",Your TVS two-wheeler insurance has been renewed.<a href='https://tvscs--tst1.custhelp.com/app/customer/selfserviceview/instrumentdetails/1' style='color:blue; padding:5px;'>Click here to download the insurance document</a></h5></div><li class='divider'></li>"
															// d=JSON.parse(d);
