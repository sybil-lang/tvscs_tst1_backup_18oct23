...
<div class="contacts"><p> <a href="http://183.87.127.174:8484/careers/">careers</a></p>  </div>
            ...
            <?php if ($enable_walkin_customers) { ?>
              <li class="dropdown">
                ...
                <ul class="dropdown-menu">
                  ...
                  <li>
                    <a href="<?php echo $site_url; ?>/app/employee/walkin_reports"><i class="fa fa-male"></i>&nbsp;Walkin Reports</a>
                  </li>
                </ul>
              </li>
  ...
  <div id="customerModal" class="modal fade" role="dialog">
    ...
    <div id="error_message" style="display: none;">
      <p class="tagr"> “This agreement is transferred International Asset Reconstruction Company Private Limited (“IARC”). Hence loan details are not available."</p>
    </div>
    ...
    <script type="text/javascript">
      ...
      $("#agreement_number").on("input", function() {
    ...
    <script type="text/javascript">
      ...
      console.log("Added msg for testing".Number.isInteger(agg));
      var text1 = $("#agreement_number").tautocomplete({
        ...
        ajax: {
          ...
          success: function(result) {
            ...
            return filterData;
            console.log("i am here", filterData)
          }
        },
        onchange: function() {
          console.log(" ia m changing")
          // $("#ta-txt").html(text2.text());
          $('#error_message').hide();
          $('#c_code').val(text1.id());
      ...
      if (agg[1] && !prof) {
        ...
        $.ajax({
          ...
          success: function(result) {
            var customerId = $('#c_code').val();
            var agreementNo = $('#c_agreement').val();
            if (customerId && agreementNo) {
              var filterData = [];
              var data = agg[1];
    ...
    <script type="text/javascript">
      ...
      //     success: function(response) {
      //       //alert(response);
      //       // console.log("i am here finnaly ",response)
