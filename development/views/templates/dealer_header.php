...
<head>
  ...
  <style type="text/css">
    ...
    div.timepicker-picker div.table-condensed tbody tr td .btn,
    .timepicker-picker .table-condensed tbody tr td .btn-primary {
    ...
    <header id="header1">
      <div class="container1">
        ...
        if (!empty($userData['sess_email'])) { ?>
          <div class="col-md-3 col-xs-12 text-xs-center text-md-left">
            <!--<strong>Email: <i class="fa fa-envelope"></i>  <a href="mailto:dealer.helpdesk@tvscredit.com">dealer.helpdesk@tvscredit.com</a></strong> -->
          </div>
        <?php } else { ?>
          <div class="pull-right login-search-panel">
            <ul class="nav-menu navbar-right primary-menu">
                ...
                <ul class="dropdown-menu slide-animate">
                  <li>
                    <div class="contact-info">
                      <div class="contacts">
                        <p><img src="/euf/assets/themes/standard/Images-new/mobile_icon/contact-us icon.png">Contact Us: <a href="callto://+18001030010">1800 103 0010</a></p> (Toll Free)
                      </div>
                    </div>
                  </li>
...
">
            <div class="contact-info">
              <div class="contacts">
                <p><img src="/euf/assets/themes/standard/Images-new/contact-us icon.png">Contact Us: <a href="callto://+18001030010">1800 103 0010</a></p> (Toll Free)
              </div>
            </div>
            <div class="contact-info">
              <div class="contacts">
            ...
            <div class="contact-info">
              <div class="contacts">
                <p> <img src="/euf/assets/themes/standard/Images-new/message-icon.png"><a href="mailto:dealer.helpdesk@tvscredit.com">dealer.helpdesk@tvscredit.com</a></p>
              </div>
            </div>
            <rn:condition logged_in="true">
              <div class="dropdowns">
        ...
        <nav>
          <div class="rn_NavigationBar">
            ...
            <ul class="rn_NavigationMenu" style="text-align: center;">
              ...
              <!--<li>
							<i class="icon-envelope"></i> <a href="<? php // echo $site_url;
                                                      ?>/app/account/profile">General</a>
						</li>
						<li>
