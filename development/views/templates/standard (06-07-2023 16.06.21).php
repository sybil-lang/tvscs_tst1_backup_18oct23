...
,buttons.dataTables.min.css" />
	...
	if ($contact_id != null) {
		...
		$path = (explode("/", $path));
		// header('Location:https://tvscs--tst1.custhelp.com/app/site_maintenance');
		// exit;
		// print_r($path);
		//  exit;
		if ($path[2] == "msme") {
			...
			<div class="container1">
				...
				<div class="pull-right login-search-panel">
					<ul class="nav-menu navbar-right primary-menu">
								...
								<div class="dropdowns">
									...
									<ul class="dropdown-menu notifications" role="menu" aria-labelledby="dLabel">
										...
										<div class="notification-heading">
											...
											<h4 class="menu-title pull-right"><a id='view_all_noti1' href="<?php echo $site_url; ?>/app/customer/selfserviceview/notification/1">View all</a><i class="glyphicon glyphicon-circle-arrow-right"></i></h4>
										</div>
										<li class="divider"></li>
										...
										<div class="notification-footer" style="background-color: #3f6c9c;text-align: center;">
											<h4 class="menu-title"><a id='view_all_noti2' style="color: black !important;" href="<?php echo $site_url; ?>/app/customer/selfserviceview/notification/1">View all</a><i class="glyphicon glyphicon-circle-arrow-right"></i></h4>
										</div>
									</ul>
								</div>
							</rn:condition>
						...
						<!-- <script type="text/javascript">
							// $('#view_all_noti1').click(function(){
							// 						//Some code
							// 						console.log("i am clicked");
							// 						localStorage.setItem("view_noti_1", "1");
							// 					});

							// 					$('#view_all_noti2').click(function(){
							// 						//Some code
							// 						console.log("i am clicked");
							// 						localStorage.setItem("view_noti_2", "1");
							// 					});
							...
							if (contactid) {
								...
								$.post("/cc/AjaxCustom/agreements", {
									...
									.done(function(data) {
										...
										console.log("agreements API",JSON.parse(data));
										dataa = JSON.parse(data)
										if (dataa.length > 0) {
											for (var i = 0; i < dataa.length; i++) {

												//RC PENDING NOTIFCATION
