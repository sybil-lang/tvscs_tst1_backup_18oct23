...
$site_url='https://tvscs.custhelp.com/app/'.$section.'/dashboard';
		...
		<div class="megamenu-container">
			<div class="main-menu">
				<div class="container">
					<div class="grid_12">
						<ul id="menu">
							<li><a href="<?php echo $site_url;?>" class="active"><span><i class="fa fa-home" aria-hidden="true"></i>  </span><br></a> </li>
