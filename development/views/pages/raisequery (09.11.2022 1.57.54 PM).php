        ...
        $('#rn_submitform').on('click', function(e) {
            ...
            if ((cat == 53 || cat == 84 || cat == 1891 || cat == 1812 || cat == 86 || cat == 93 || cat == 77 || cat == 1812 || cat == 56 || cat == 82 || cat == 58 || cat == 1727) && ag_no) {
                ...
                if (cat == 1727) {
                    ...
                    //         var ResultResponse4 = cdmobileunlock(i, p);
                        ...
                        buttons: {
                            ...
                            Yes: {
                                ...
                                callback: function(result) {
                                    ...
                                    //     console.log(event.target['imei'].value);
                                    //     console.log(event.target['passkey'].value);
                                    // }
                                    ...
                                    // console.log(i);
                                    // console.log(document.getElementById('imei').value);

                                    // if (document.getElementById('imei') != null) {
                                    //     // str = document.getElementById("imei").value;
                                    //     // console.log(str);

                                    //     var inputString = $("#imei").val();
                                    ...
                                    //     // console.log(document.getElementById('passkey').value);
                                    // }
                                    //calling cd unlock mobile api
                                    ...
                                    if (ResultRespons4.message.includes("Released")) {
                                    ...
                                    //diplay message 2
                                    if (ResultRespons4.message.includes("invalid")) {
