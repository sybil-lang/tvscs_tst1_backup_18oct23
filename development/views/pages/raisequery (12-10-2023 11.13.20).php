...
<div class="rn_PageContent rn_AskQuestion rn_AccountOverview rn_Container">
    <div class="rn_ContentDetail">
        ...
        <form id="rn_QuestionSubmit" method="post" action="#" class="styled" enctype="multipart/form-data">
            ...
            <div class="col-lg-12 col-md-12 col-sm-12" id="preferred" style="display: block;">
            ...
            <div class="col-lg-6 col-md-6 col-sm-12" id="dispatch" style="display: block;">
            ...
            <div class="col-lg-12 col-md-12 col-sm-12" id="pinnm" style="display: block;">
...
<script type="text/javascript">
    ...
    $(document).ready(function() {
        ...
        //rn_SelectionInput_17_Incident.CustomFields.c.preferred_address
        ?>
        ...
        $('select[name="formData[Incident.Category]"').change(function() {
            $('#messageTerm').html("");
            document.getElementById('rn_SelectionInput_17_Incident.CustomFields.c.preferred_address').value = "";
            document.getElementById('pinnm').style.display = "none";
            document.getElementById('pincode').value = "";
            // id="rn_SelectionInput_38_Incident.CustomFields.c.preferred_address"
                ...
                if (cat == 1727) {
                    ...
                    bootbox.dialog({
                        message: "<form id='formId' action='' style='color:black;'>\
                                Kindly enter the Passkey  displayed on your locked mobile screen: <input type='number' name='passkey' id='passkey' min='10000000' max='999999999999' />\ Passkey:<input type='text' name='passkey' id='passkey' />\
                                                                                            </form>",
                        // swapButtonOrder: true,
                        // size:'small',
                        buttons: {
                            ...
                            Yes: {
                                ...
                                callback: function(result) {
                                    ...
                                    if (ResultRespons4 && ResultRespons4.status && ResultRespons4.message) {
                                        if (ResultRespons4.status.includes("ER") && ResultRespons4.message.includes("unlocked")) {
                                    ...
                                    if (ResultRespons4 && ResultRespons4.status && ResultRespons4.message) {
                                        if (ResultRespons4.status.includes("ER") && ResultRespons4.message.includes("available")) {
                                            console.log("Agreement Number not available");


                                            bootbox.alert({
                                                message: "Entered agreement number is not available",
                                                callback: function(result) {
                                                    location.reload();
                                                }
                                            });
                                    ...
                                    if (ResultRespons4 && ResultRespons4.status && ResultRespons4.mesage) {
                                        if (ResultRespons4.status.includes("ER") && ResultRespons4.mesage.includes("expired")) {
                                            // if (ResultRespons4.result.includes("FAIL")) {
                                            // console.log("DEVICE_STATE_INVALID / This Password has been expired");
                                            // location.reload();
                                            // document.getElementById("formId").reset();
                                            bootbox.alert({
                                                message: "The entered password has been expired",
                                    ...
                                    // message
                                    //     :
                                    //     "Agreement Number/Challenge invalid"
                                    // status
                                    //     :
                                    //     "ER"
                                    //diplay message 2
