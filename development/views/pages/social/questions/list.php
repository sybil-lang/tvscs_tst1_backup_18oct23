<rn:meta title="#rn:msg:FIND_DISCUSSIONS_LBL#" template="standardlogincust.php" clickstream="answer_list"/>
<style>
.rn_SourceFilter label
    {
        color:white;
    }
.rn_SourceFilter select, .rn_SourceFilter option
    {
        color:black;
    }
 .rn_SourceFilter select
    {
        margin:20px;
    }
    ...
    <div class="rn_HeroInner">
        <div class="rn_SearchControls">
            ...
            <div class="rn_SearchFilters">
                <div class="row"><div class="col-md-3"><rn:widget path="searchsource/SourceProductCategorySearchFilter" verify_permissions="true"/></div>
             ...
             <div class="col-md-3">   <rn:widget path="searchsource/SourceFilter"
                    ...
                    labels="#rn:php:\RightNow\Utils\Config::getMessage(LAST_DAY_LBL) . ',' . \RightNow\Utils\Config::getMessage(LAST_WEEK_LBL) . ',' . \RightNow\Utils\Config::getMessage(LAST_MONTH_LBL) . ',' . \RightNow\Utils\Config::getMessage(LAST_YEAR_LBL)#"
                                                 label_input="#rn:msg:FILTER_BY_AGE_LBL#"/></div>
            <div class="col-md-3">    <rn:widget path="searchsource/SourceFilter"
                    ...
                    labels="#rn:php:\RightNow\Utils\Config::getMessage(YES_LBL) . ','  . \RightNow\Utils\Config::getMessage(NO_LBL)#"
                                                 label_input="#rn:msg:FILTER_BY_BEST_ANSWER_LBL#"/></div>
                </rn:container>
            </div>
                </div>
        </div>
