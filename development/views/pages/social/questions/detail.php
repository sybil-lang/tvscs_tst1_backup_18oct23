<rn:meta title="#rn:php:\RightNow\Libraries\SEO::getDynamicTitle('question', \RightNow\Utils\Url::getParameter('qid'))#" template="standardlogincust.php" clickstream="question_view"/>
