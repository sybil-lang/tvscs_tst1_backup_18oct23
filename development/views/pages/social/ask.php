<rn:meta title="Ask the Community" template="standardlogincust.php" login_required="true" clickstream="question_create"/>
...
<div class="rn_Hero">
    <div class="rn_HeroInner">
        ...
        <br>
        <p>#rn:msg:NEED_HELP_FROM_A_SUPPORT_PROFESSIONAL_LBL# <a href="/app/ask">#rn:msg:ASK_OUR_SUPPORT_STAFF_LBL# →</a></p>
    </div>
</div>
