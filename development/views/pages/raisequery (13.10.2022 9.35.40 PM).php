    ...
    function NocRequest_CheckLive(mobile, ag_no) {
        ...
        $.ajax({
            ...
            success: function(data) {
                ...
                // console.log('for noc live check', parseXmlToJson(data));
                dataAAA = parseXmlToJson(data); // Resolve promise and go to then()
                console.log('for noc live check', JSON.parse((dataAAA.RequestNOCResponse.RequestNOCResult))); // Resolve promise and go to then()
    ...
    function Nocdispatchdapi(mobile, ag_no) {
        ...
        $.ajax({
            ...
            success: function(data1) {
                ...
                console.log('for dispatched api', JSON.parse((dataAAA1.RequestNOC_EXTResponse.RequestNOC_EXTResult))); // Resolve promise and go to then()
        ...
        $('#rn_submitform').on('click', function(e) {
            ...
            if ((cat == 53 || cat == 84 || cat == 1891 || cat == 1812 || cat == 86 || cat == 93 || cat == 77 || cat == 1812 || cat == 56 || cat == 82 || cat == 58) && ag_no) {
                ...
                $.post('/cc/AjaxCustom/ca_api', {
                    ...
                    .done(function(data) {
                        console.log("data coming from ca_Api for 5 categories", data);
                        // customalrtbox(data);
                        // if (data.length != 0) {
                        var daata = JSON.parse(data);
                        console.log("data from ca_api after parsing", daata);
                        deta = daata;
                        dob = deta.dob;
                        mobile = deta.mobile;
                        ...
                        if (cat == 58) {
                            ...
                            if (ResultRespons3.Status_Code == 1 && (ResultRespons3.Result.includes("Active"))) {
                                ...
                                console.log('first if:1& Dispatched');
                                //display msg5
                            ...
                            //if status_Code=ER
                                ...
                                console.log(" first if:ER");
                                ///////////////////////
                                //checking if its closed or oprn
                                if (daata.status) {
                                    //for open request

                                    if (daata.status != "2") {
                                        console.log('first if:open request');
                                        var Stat = "Unresolved";
                                    ...
                                    //for closed request
                                        ...
                                        console.log("first if:closed request");
                                        //closed request
                                        var Stat = "Resolved";
                                        ...
                                        if (cat == 58) {
                                            bootbox.dialog({
                                                ...
                                                buttons: {
                                                    ...
                                                    //trigger API to check the PL loan eligibility:
                                                    Yes: {
                                                        label: 'Yes',
                                                        // className: 'btn-danger',
                                                        callback: function(result) {
                                                            console.log('first if:trigger pl loan api')
                                                            $.ajax({
                                                                type: "POST",
                                                                ...
                                                                success: function(nocEligibility) {
                                                                    ...
                                                                    //if eligible
                                                                    if (txt > 0) {
                                                                        console.log("first if:trigger pl:eligible")
                                                                        bootbox.dialog({
                                                                            ...
                                                                            buttons: {
                                                                                ...
                                                                                // if clicks on yes->trigger api to invoke pl->if status_code=1->display msg6
                                                                                Yes: {
                                                                                    label: 'Yes',
                                                                                    // className: 'btn-danger',
                                                                                    callback: function(result) {
                                                                                        ...
                                                                                        console.log('first if:if needed:invoke pl:msg6')
                                                                                ...
                                                                                //if clicks on no->trigger  api to validate noc->display msg4
                                                                                No: {
                                                                                    label: 'No',
                                                                                    callback: function(result) {
                                                                                        var ResultResponse = NocRequest_CheckLive(mobile, ag_no)
                                                                                        cconsole.log('first if:not needed:validate noc:mssg4')
                                                                    ...
                                                                    //if not eligible->trigger api to validate noc->display msg4
                                                                    else {
                                                                        var ResultResponse = NocRequest_CheckLive(mobile, ag_no)
                                                                        console.log('first if:validate noc:msg4')
            ...
            if (cat != 58) {
                ...
                $.post('/cc/AjaxCustom/ca_api', {
                    ...
                    .done(function(data) {
                        ...
                        var daata = JSON.parse(data);
                        deta = daata;
                        console.log("data from ca_api after parsing", deta);
                        dob = deta.dob;
                        mobile = deta.mobile;
                        customername = deta.customername;
                        response = deta.responseSent;
                        ...
                        var ResultResponse3 = Nocdispatchdapi(mobile, ag_no);
                        if (ResultRespons3.Status_Code == 1 && (ResultRespons3.Result.includes("Active"))) {
                            console.log('second if:1&active')
                            ...
                            console.log('second if:1& dispatched')
                            //display msg5
                            bootbox.alert("Your NOC has already been dispatched on 05-FEB- 16 through The Professional Courier, Airway bill no. is MAA922270295", function()
                        ...
                        //if status_Code=ER
                            ...
                            $.ajax({
                                ...
                                success: function(nocEligibility) {
                                    ...
                                    //if eligible
                                    if (txt > 0) {
                                        console.log('second if:if eligible')
                                        bootbox.dialog({
                                            message: "<span style='color:black;'>You are eligible for the Personal Loan of Rs. " + txt + " would like to avail the Personal Loan?</span>",
                                            // swapButtonOrder: true,
                                            // size:'small',
                                            buttons: {
                                                ...
                                                Yes: {
                                                    ...
                                                    callback: function(result) {
                                                        invokepl(mobile, ag_no);
                                                        console.log('second if:if needed:invoke pl:msg6')
                                                ...
                                                No: {
                                                    ...
                                                    callback: function(result) {
                                                        var ResultResponse = NocRequest_CheckLive(mobile, ag_no)
                                                        console.log('second if:validate noc:msg4')
                                    ...
                                    //if not eligible->trigger api to validate noc->display msg4
                                        ...
                                        console.log('second if:not eligible');
                                        var ResultResponse = NocRequest_CheckLive(mobile, ag_no)
