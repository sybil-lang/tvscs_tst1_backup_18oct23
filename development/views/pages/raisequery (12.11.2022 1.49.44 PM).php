...
<script type="text/javascript">
    ...
    function cdmobileunlock(imei, passkey) {
        $.ajax({
        ...
        $('#rn_submitform').on('click', function(e) {
            ...
            if ((cat == 53 || cat == 84 || cat == 1891 || cat == 1812 || cat == 86 || cat == 93 || cat == 77 || cat == 1812 || cat == 56 || cat == 82 || cat == 58 || cat == 1727) && ag_no) {
                ...
                if (cat == 1727) {
                    ...
                    $.post('/cc/AjaxCustom/outstanding_verification', {

                            ag_no: ag_no,
                        })
                        .done(function(data) {
                            console.log('data coming from outstanding_verification', data);
                            // customalrtbox(data);
                            var daata = JSON.parse(data);
                            console.log(daata);
                            var ReturnOutput = daata.ReturnOutput;
                            console.log(ReturnOutput);

                            if (ReturnOutput != null) {

                                var result = ReturnOutput[0].PRINCIPAL_OUTSTANDING;
                                console.log(ReturnOutput[0].PRINCIPAL_OUTSTANDING);
                                // if (result > 50) {
                                ...
                                console.log("inside more then 50.Trigger cd mobile api");
                                // alert('trigger cd mbile api');

                                bootbox.dialog({
                                    message: "<form id='formId' action='' style='color:black;'>\
                                    IMEI:<input type='text' name='imei' id='imei'/><br/>\
                                    Passkey:<input type='text' name='passkey' id='passkey' />\
                                    </form>",
                                    // swapButtonOrder: true,
                                    // size:'small',
                                    buttons: {
                                        ...
                                        Yes: {
                                            ...
                                            callback: function(result) {
                                                ...
                                                var ResultResponse4 = cdmobileunlock(imei, passkey);
                                                ...
                                                // var a = "Device not unlocked/Released";
                                                // var a = "SR";
                                                // var a = "IMEI/Challenge invalid";
                                                // var a = 20;

                                                // if (a == 10) {
                                                // if (a.includes("Released")) {
                                                if (ResultRespons4.status.includes("ER") && ResultRespons4.message.includes("Released")) {

                                                    console.log("device not unlocked/Released");
                                                    // bootbox.alert("Your loan account has an overdue. Please click here to make the payment online-  <a class=\"uderline\" target=\"_blank\" href=\"https://pguat.tvscredit.com/\"></a>", function()
                                                ...
                                                if (ResultRespons4.status.includes("SR")) {
                                                    ...
                                                    // bootbox.alert("Dear Customer, To unlock your mobile phone, please note the PIN" + ResultRespons4.pin + "and enter it on your phone.", function()
                                                                ...
                                                                buttons: {
                                                                    ...
                                                                    Yes: {
                                                                        ...
                                                                        callback: function(result) {
                                                                            ...
                                                                            // var i = document.getElementById("imei").value;
                                                                            // var p = document.getElementById("passkey").value;

                                                                            // var i = document.getElementById("yui_3_17_2_12_1667378408311_180").value;
                                                                            // var p = document.getElementById("yui_3_17_2_12_1667378408311_188").value;
                                                                            // console.log("i &p", i, p);
                                                                                                ...
                                                                                                Yes: {
                                                                                                    ...
                                                                                                    callback: function(result) {
                                                                                                        ...
                                                                                                        if (ResultRespons4.status.includes("ER") && ResultRespons4.message.includes("Challenge")) {
                                                                                                            ...
                                                                                                            // bootbox.alert("You are not eligible to raise this request as the PASSKEY you have entered is invalid", function()
                                            ...
                                            bootbox.dialog({
                                                ...
                                                buttons: {
                                                    ...
                                                    Yes: {
                                                        ...
                                                        // className: 'btn-danger',
                                                        callback: function(result) {
                                                            console.log('if needed ,call invoke pl');
                                                            invokepl(mobile, ag_no);
