...
var c = url.searchParams.get("m_login");
var rcpull = url.searchParams.get("rcpull");
console.log(c);
console.log(c);
if(c)
{
  localStorage.setItem("m_login", "1");  
}
else
{
  localStorage.setItem("m_login", "0");  

}
if(rcpull)
{
localStorage.setItem("rcpull", "1"); 
}
else
{
    ...
    <div class="rn_Container">
        <script type="text/javascript">
            ...
            $(document).ready(function(){
                //comment below event for UAT otp disablement on CP
...
console.log('this',this.id);
var pass=$('#rn_LoginOtp_6_Otp').val();
console.log(pass);

// console.log('submit click');
// console.log('submit button click-calling IARC function');
//                     var contact_id = '<?php echo $contact_id; ?>';

//             $.post( "/cc/AjaxCustom/IARCScenarioCheck", {
