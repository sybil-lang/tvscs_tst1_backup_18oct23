	...
	<form action='#' method='post' class="loan-form">
		<fieldset>
			...
			<div class="col-sm-12 col-md-12 col-lg-12" id="contemt-main">
				...
				<div id="showresult_mandate" style='display:none'>
					<div class="row">
						<div class="col-md-3" id="mandate">
							<a href="javascript:void(0);" id="url_for_mandate1"><img src='/euf/assets/themes/standard/images/clipboard_icon-1.png' height="100" width="100"></a>
				...
				<br />
				<!-- <a href="javascript:void(0);" id="download-button1" style="display: none;"><img src='/euf/assets/themes/standard/images/clipboard_icon-1.png' height="100" width="100"></a>
				<p id="para1" style="display: none;">NDC</p> -->
				...
				<script type="text/javascript">
					...
					$.post("/cc/AjaxCustom/rest_api_report", {
						...
						.done(function(data) {
							...
							// 			await $("#download-button11").hide(); //shows div.
							// 			await $("#para1").hide(); //shows div.
							// 			alert("Other Portfolio NDC Not Available for this Agreement Number")
							// 			// console.log("data3");
							// 		} else {
							// 			console.log("inside secound else");
							// 			$("#download-button1").show(); //shows div.
							// 			$("#para1").show(); //shows div.
							// 			$('#download-button1').unbind().click(() => {
							// 				// console.log("hello");
							// 				pdf_generation(a);
							// 				// console.log("hellow1");
					...
					$('a#url_for_mandate1').click(function(e) {

						var agg_no = $('#i_detailm').val();
