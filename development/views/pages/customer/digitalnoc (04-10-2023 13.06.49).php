    ...
    <form action='#' method='post' class="loan-form">
        <fieldset>
            ...
            <div class="col-sm-12 col-md-12 col-lg-12" id="contemt-main">
                ...
                <p id="msg" style="display: none;">Please note that the NOC validity has expired.<a href="#"  class="id1" style="font-weight:bold"> Please click on the below   payment link </a> and pay Rs.500 to raise a request for the Duplicate NOC.”
                </p>
