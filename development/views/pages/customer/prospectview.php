...
if(!empty($agg_no)){
	...
	if(!in_array_r($agreement_id,$response)){
			header("location:/app/customer/error/error_id/2");
			exit;
	}
}
...
<div class="rn_PageContent rn_AccountOverview rn_Container_dash">
	...
	<div id="page">
        ...
        <div id="tabbed-nav2" >
            ...
            <!-- Content container -->
            <div>
                <div data-content-url='<?php echo $site_url;?>/app/customer/login_status/ag_id/<?php echo $agreement_id;?>'></div>
                <div data-content-url='<?php echo $site_url;?>/app/customer/payment_details/ag_id/<?php echo $agreement_id;?>'></div>
                <div data-content-url='<?php echo $site_url;?>/app/customer/loan_schedule/ag_id/<?php echo $agreement_id;?>'></div>
                <div data-content-url='<?php echo $site_url;?>/app/customer/charges/ag_id/<?php echo $agreement_id;?>'></div>
            </div>
