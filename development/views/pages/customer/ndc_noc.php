	...
	<form action='#' method='post' class="loan-form">
		<fieldset>
			...
			<div class="col-sm-12 col-md-12 col-lg-12" id="contemt-main">
				...
				<p id="msg" style="display: none;">Since NOC validity period is expired, Please pay Rs. 500/- Duplicate NOC charges and avail Digital NOC
				...
				<script type="text/javascript">
					...
					$.post("/cc/AjaxCustom/rest_api_report", {
							...
							filtering_val: 'mandateStatus_ndc',
							method_val: 'getMandateStatus_ndc'
						})
						// 
						.done(function(data) {
							...
							//---otherportNoc--
							let source = document.querySelector('#i_detail_s');
