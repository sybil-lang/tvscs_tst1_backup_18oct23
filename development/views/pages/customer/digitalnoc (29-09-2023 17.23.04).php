    ...
    <form action='#' method='post' class="loan-form">
        <fieldset>
            ...
            <div class="col-sm-12 col-md-12 col-lg-12" id="contemt-main">
                ...
                <p id="msg" style="display: none;">Please note that the NOC validity has expired. Please click on the below link <a href="#" id="paymentLink">Payment link</a> and pay Rs.500 to raise a request for the Duplicate NOC.”
                </p>
