    ...
    <form action='#' method='post' class="loan-form">
        <fieldset>
            ...
            <div class="col-sm-12 col-md-12 col-lg-12" id="contemt-main">
                ...
                <p id="msg" style="display: none;">Please note that the NOC validity has expired. Please click on the below link <Payment link> and pay Rs.500 to raise a request for the Duplicate NOC.”
                </p>
                <p id="msg2">
                    NOC is not available for the selected agreement number. Please
                    <a href="https://tvscs--tst1.custhelp.com/app/raisequery">click here</a>
                    to raise a request for NOC. Our customer care executive will reach out to you.
                </p>

                <p id="msg3" style="display: none;">“Your Loan is active. NOC can only be provided on completion of your loan.”
                </p>
