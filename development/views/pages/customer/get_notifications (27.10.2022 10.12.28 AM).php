			      ...
			      .done( function( data ) 
			      {
			      	...
			      	dataa=JSON.parse(data)
			      			if(dataa.length>0)
									...
									$.post( "/cc/AjaxCustom/InsuranceNotification", { agg:dataa[k]})
									      .done( function( data ) 
									      	{
									      	 ...
									      	 if(data.includes('FIRSTNAME'))
									      	 {
												console.log("under testdata if");
		                                     	...
		                                     	document.getElementById('notification-page').innerHTML+="<div class='notification-item-read notice info'><h5 class='item-title'>Hi "+d[0]['FIRSTNAME']+",Your TVS two-wheeler insurance has been renewed.<a href='https://tvscs--tst1.custhelp.com/app/customer/selfserviceview/instrumentdetails/1' style='color:blue; padding:5px;'>Click here to download the insurance document</a></h5></div><li class='divider'></li>"
									      	 	// d=JSON.parse(d);
							      	...
							      	$.post( "/cc/AjaxCustom/BounceNotification", { agg:dataa[k]})
									      .done( function( data ) 
									      	{
			      		      		...
			      		      		$.post( "/cc/AjaxCustom/MandateRejectNotification", { agg:dataa[k]})
									      .done( function( data ) 
									      	{
			      		      		...
			      		      		$.post( "/cc/AjaxCustom/NOCPendingNotification", { agg:dataa[k]})
									      .done( function( data ) 
									      	{
									      		if(data.includes('AGREEMENTNO'))
									      	 {
			      		      		...
			      		      		$.post( "/cc/AjaxCustom/MandateSuccessNotification", { agg:dataa[k]})
									      .done( function( data ) 
									      	{
									      		if(data.includes('AGREEMENTNO'))
									      	 {
			      		      		...
			      		      		$.post( "/cc/AjaxCustom/ClearedNotification", { agg:dataa[k]})
									      .done( function( data ) 
									      	{
			      		      		...
			      		      		$.post( "/cc/AjaxCustom/PNTNotification", { agg:dataa[k]})
									      .done( function( data ) 
									      	{
									      		if(data.includes('AGREEMENTNO'))
									      	 {
											  ...
											  $.post( "/cc/AjaxCustom/BirthdayNotification", { contactid:dataa[k]})
									      .done( function( data ) 
									      	{
												//console.log(k);
												if(k== 0)
											  ...
											  $.post( "/cc/AjaxCustom/WelcomeLetterNotification", { agg:dataa[k]})
									      .done( function( data ) 
									      	{
