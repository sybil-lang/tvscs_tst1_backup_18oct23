...
// 	// print_r($row['Transferred Agreement']);
//     while ($row = $arr->next()) {
//     echo $row['Transferred Agreement'];
//     if($row['Transferred Agreement'] == "Yes")
//     {
//         $CountTransferredAg ++;
//         echo $CountTransferredAg;
//     }
...
//     }
	...
	// {
	// 	$row = $arr->next();
	// 	$TransferredAg=$row['Transferred Agreement'] ;
	// 	if($TransferredAg == "Yes" )
	// 	{
	// 		$CountTransferredAg++;
	// 	}
...
// 		}
	...
	// $response = report_result($report_id, $contact_id);
    //         $count_agreements = count($response);
    //         $transferred_agreement[] = array();
    //         echo $count_agreements;
    //         $i = 0;
    ...
    //                 $transferred_agreement[$i] = $result['Agreement No'];
	// 				echo 'transferred agreement'.$transferred_agreement[$i];
    //                 $i++;
    //             }
    //         }
///IARC CR
...
<script type="text/javascript">
 ...
 console.log(SingleAg_IARC);
	if ( mlogin == "1" ) {

		location.href = "https://tvscs--tst1.custhelp.com/app/account/profile?mlogin=1";
		console.log('test');

	}
	if ( rcpull == "1" ) {

		location.href = "https://tvscs--tst1.custhelp.com/app/customer/selfserviceview";
	}
	if ( SingleAg_IARC == "1" ) 
	{
...
<div class="container">
	<div class="modal fade" id="staticBackdrop" data-backdrop="static" data-keyboard="false" tabindex="-1"
		...
		<div class="modal-dialog modal-sm">
			<div class="modal-content"
				style="overflow-y: hidden; height: 237px; position: fixed; top: -30px; width: 389px;">
				...
				<div class="modal-footer">
					<button type="button" id="btn_applynow" class="btn btn-success"
						style="margin:2px; border-radius: 30px;margin-top: 2px;width: 48%;">Apply Now</button>
					<button type="button" class="btn btn-danger" id="btn_cancel"
						style="border-radius: 30px;margin-top: 2px;width: 48%;" data-dismiss="modal">Cancel</button>
...
<div class="container">
	<div class="modal fade" id="myModalforApplyNow" role="dialog" data-backdrop="static" data-keyboard="false"
			...
			<div class="modal-content" style="overflow-y: hidden;height: 349px;">
				...
				<div class="modal-body" style="height:auto;">
					...
					<form>
						<div class="form-group">
							...
							<label id="Warning" style="color:red; display:none;">Please enter a value greater than 1000
								& less than approved loan amount.</label>
				...
				<div class="modal-footer" style="text-align: center;">
					<button type="button" class="btn btn-success"
						style="margin:2px; border-radius: 30px;margin-top: 2px;width: 48%;" id="btn_LoanApplied">Apply
						Now</button>
...
<div class="modal fade" id="myModalforApplyNow2" role="dialog">
	<div class="modal-dialog modal-sm">
		...
		<div class="modal-content" style="height: 245px;overflow-y: hidden;">
			...
			<div class="modal-body">
				<p>Thanks for your interest in pre-approved personal loan. Our executive will get in touch with you
					shortly</p>
			</div>
			<div class="modal-footer" style="text-align: center;">
				<button type="button"
					style="background-color: #115184;color: white;margin:2px;height: 29px; border-radius: 30px;margin-top: 2px;width: 48%;"
