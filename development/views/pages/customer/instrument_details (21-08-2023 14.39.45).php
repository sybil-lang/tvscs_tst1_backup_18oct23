...
<body>
	...
	<!-- IARC CR Chnages -->
	<div class="modal-dialog modal-dialog-centered" id="IarcModal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" style="display:none;">
...
For online access and payment: res.iarc.co.in
				...
				<div class="modal-footer">
					<center><button type="button" id="popup_close1" style="background-color: #115184;color: white;margin:2px;height: 29px; border-radius: 30px;margin-top: 17px;width: 48%;" data-dismiss="modal">Ok</button></<center>
	...
	<div id="instrumentdetails_docs" style='display:none'>
		<div class="row">
			<div class="col-md-4">
				<a href="javascript:void(0);" target="_blank" id="url_ins"><img src='/euf/assets/themes/standard/images/clipboard-icon.png' height="100" width="100"></a>
				<p>Insurance Policy Renewal</p>
			</div>
			<div class="col-md-4" id="forclosure">
				<a href="javascript:void(0);" target="_blank" id="url_for"><img src='/euf/assets/themes/standard/images/documents-flat.png' height="100" width="100"></a>
	...
	<div id="showresult_instrument" style='display:none'>
		<div class="row">
			<div class="col-md-3" id="forclosure_n">
				<a href="javascript:void(0);" target="_blank" id="url_for_n"><img src='/euf/assets/themes/standard/images/documents-flat.png' height="100" width="100"></a>
				<p>Foreclosure Letter</p>
			</div>
			...
			<div class="col-md-3" id="insss">
				<a href="javascript:void(0);" target="_blank" id="url_inss"><img src='/euf/assets/themes/standard/images/clipboard-icon.png' height="100" width="100"></a>
				<p>Insurance Policy Renewal</p>
			</div>
			<div class="col-md-4" id="paperlessnoc">
				<a href="javascript:void(0);" id="url_for_paperlessnoc"><img src='/euf/assets/themes/standard/images/clipboard_icon-1.png' height="100" width="100"></a>
				<p>Paperless NOC</p>
			</div>
		</div>
		<div>
	...
	<a href="javascript:void(0);" id="btn1" style="display: none;"><img src='/euf/assets/themes/standard/images/clipboard_icon-1.png' height="100" width="100"></a>
	<p id="para1" style="display: none;">Download Repayment Letter</p>

	<!-- DIGITAL NOC -->
	<a href="javascript:void(0);" id="dnoc" style="display: none;"><img src='/euf/assets/themes/standard/images/clipboard_icon-1.png' height="100" width="100"></a>
	<p id="dnocpara1" style="display: none;"> DIGITAL NOC</p>

	<a href="javascript:void(0);" id="url_for_n_soa" style="display: none;"><img src='/euf/assets/themes/standard/images/clipboard_icon-1.png' height="100" width="100"></a>
	...
	<script type="text/javascript">
		...
		$.post("/cc/AjaxCustom/rest_api_report", {
				...
				filtering_val: 'instrumentdetails',
		...
		$('a#url_for_n_soa').click(function(e) {
			...
			$.post("/cc/AjaxCustom/soa_download_for_customer", {
					agg_no: agg_no,
					mobile: mobile
				})
				.done(function(data) {
		...
		function pdf_DigitalNoc(id) {
			console.log("inside pdf_DigitalNoc");
