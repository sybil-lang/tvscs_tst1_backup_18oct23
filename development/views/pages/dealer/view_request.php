        ...
        <div class="rn_Questions">
            <rn:container report_id="100092" per_page="4">
                <div class="rn_HeaderContainer">
						<div class="col-md-6">
								<h2><a class="rn_Questions" href="/app/dealer/account/questions/list#rn:session#">Summary of TA Requests</a></h2>
						</div>
						<div class="col-md-6">
								<p style="padding-top:10px !important;float:right;">
									...
									//$(function() {
										...
										function cb(start, end) {
											var url = "/cc/DealerCustom/getTADataList?startDate="+start.toISOString()+"&endDate="+end.toISOString();
...
<script type="text/javascript">
			 ddtable = $('#ta_list').DataTable( {
						 "ajax": {
								url: "/cc/DealerCustom/getTADataList",
								dataSrc: "",
								method: 'post',
								data: param
							},
