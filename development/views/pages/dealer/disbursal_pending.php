...
var optionspdd_bar;
	optionspdd_line = {
            ...
            title: {
                useHTML: true,
                text: '<a href="https://tvscs.custhelp.com/app/dealer/dealer_disbursal_detail#disbursalPending" id="linktopdd">Sales Performance Details In '+$("[id$=hfFirstYear]").val()+'</a>',
            },
            subtitle: {
                useHTML: true,
	...
	<div class="col-xs-12 col-sm-12 col-md-6 col-lg-8">
                  <div class="row">
						<div class='col-sm-12 form-inline datetimepickerwrapper'>
								<select name="ddlyear" id="ddlyear_2" class=" btn btn-default">
										<?php
			 ...
			 updateDisbursalChartData(pick_upstart_date,pick_upend_date,dealercode);
			  setTimeout(function(){
				...
				$("#loader").addClass("hidden");
					...
					bootbox.alert('<div class="alert alert-warning"><strong>Month Difference can not be greater than Three Months.</div>');
...
$('#ddlyear_2').on('change', function(){
		var selYear = $('#ddlyear_2').val();
		//alert(selYear);
		var s_date = '01/01/'+selYear;
		var e_date = '31/12/'+selYear;
		requestDisbursalData(s_date,e_date);
});
</script>
