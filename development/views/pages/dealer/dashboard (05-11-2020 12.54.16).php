            ...
            <div class="collapse navbar-collapse" id="myNavbar">
              <ul class="nav navbar-nav">
                  ...
                  <li class="active"><a href="javascript:void(0);" onclick="setDashboardGraph('sales_1');">Dealer Disbursal</a> </li>
					  ...
					  <li><a href="http://tvscscrmservice.tvscs.co.in/TDSDealerRed.aspx?DEALER_CODE=<?php echo $dealer_code;?>" target=newtab>GST Certificate</a></li> 
              </ul>
            </div>
          </div>
        </nav>
                ...
                <div class="row">
                  <div class="col-sm-12">
                    <ul class="nav nav-pills nav-stacked">
                      ...
                      <li><a href="javascript:void(0);" onclick="setDashboardGraph('sales_4');">PDD Pending</a></li>
                      <li><a href="javascript:void(0);" onclick="setDashboardGraph('sales_5');">Trade Advance</a></li>
					  <li><a href="http://tvscscrmservice.tvscs.co.in/TDSDealerRed.aspx?DEALER_CODE=<?php echo $dealer_code;?>" target=newtab>TDS Certificate</a></li>
                    </ul>
                  </div>
                </div>
              </div>
