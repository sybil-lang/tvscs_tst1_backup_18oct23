<rn:meta title="#rn:msg:ACCOUNT_SETTINGS_LBL#" template="dealer_header.php" login_required="true" force_https="true" />
<?php
$CI=&get_instance();
...
<div class="rn_PageContent rn_Profile rn_Container">
    ...
    <!--    <h2>#rn:msg:ACCT_HDG#</h2>-->
        ...
        <rn:condition external_login_used="false">
            <h3><a href="/app/dealer/account/change_password#rn:session#">#rn:msg:CHANGE_YOUR_PASSWORD_CMD#</a></h3>
        </rn:condition>
...
-->
       ...
       <!-- <rn:condition language_in="ja-JP,ko-KR,zh-CN,zh-HK,zh-TW">
        ...
        <rn:condition_else />
            ...
            <rn:widget path="input/FormInput" name="Contact.Phones.MOBILE.Number" label_input="Mobile Number"/>
        </fieldset>
