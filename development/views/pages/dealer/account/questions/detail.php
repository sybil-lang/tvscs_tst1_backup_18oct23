<rn:meta title="#rn:php:\RightNow\Libraries\SEO::getDynamicTitle('incident', \RightNow\Utils\Url::getParameter('i_id'))#" template="dealer_header.php" login_required="true" clickstream="incident_view" force_https="true"/>
<?php
$CI=&get_instance();
...
<div class="rn_PageContent rn_RecordDetail rn_IncidentDetail rn_Container">
    <rn:condition incident_reopen_deadline_hours="168">
        ...
        <form id="rn_UpdateQuestion" onsubmit="return false;">
                ...
                <rn:widget path="input/FormSubmit" label_on_success_banner="#rn:msg:QUESTION_SUCCESSFULLY_UPDATED_LBL#" on_success_url="/app/account/questions/list"  error_location="rn_ErrorLocation"/>
        </form>
    <rn:condition_else/>
