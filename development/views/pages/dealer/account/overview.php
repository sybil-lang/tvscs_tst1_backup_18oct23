<rn:meta title="#rn:msg:ACCOUNT_OVERVIEW_LBL#" template="dealer_header.php" login_required="true" force_https="true" />
<?php
$CI=&get_instance();
...
<div class="rn_PageContent rn_AccountOverview rn_Container">
    <div class="rn_ContentDetail">
        <div class="rn_Questions">
            <rn:container report_id="100415" per_page="4">
                <div class="rn_HeaderContainer">
                    <h2><a class="rn_Questions" href="/app/dealer/account/questions/list#rn:session#">#rn:msg:MY_SUPPORT_QUESTIONS_LBL#</a></h2>
                </div>
       ...
       <!-- <div class="rn_Discussions">
            <rn:container report_id="15156" per_page="4">
                <div class="rn_HeaderContainer">
                    <h2><a class="rn_Discussions" href="/app/dealer/social/questions/list/author/#rn:profile:socialUserID#/kw/*#rn:session#">#rn:msg:MY_DISCUSSION_QUESTIONS_LBL#</a></h2>
                </div>
                ...
                <a href="/app/dealer/social/questions/list/author/#rn:profile:socialUserID#/kw/*#rn:session#">#rn:msg:SEE_ALL_MY_DISCUSSION_QUESTIONS_LBL#</a>
            </rn:container>
        </div>-->
    </div>
    
</div>
<div class="rn_PageContent rn_AccountOverview rn_Container" style="display: flex;">
    <div class="rn_ContentDetail">
			<div class="rn_HeaderContainer">
		...
		<a href="<?php echo $site_url;?>/app/dealer/raisequery" class="btn btn-warning btn-lg active" role="button" aria-pressed="true">Raise a Query  </a>
		<p>&nbsp;</p>
        <div class="rn_Well">
            <h3>#rn:msg:LINKS_LBL#</h3>
            <ul>
                <li><a href="/app/dealer/account/profile#rn:session#">#rn:msg:UPDATE_YOUR_ACCOUNT_SETTINGS_CMD#</a></li>
                <rn:condition external_login_used="false">
                    <rn:condition config_check="EU_CUST_PASSWD_ENABLED == true">
                        <li><a href="/app/dealer/account/change_password#rn:session#">#rn:msg:CHANGE_YOUR_PASSWORD_CMD#</a></li>
                    </rn:condition>
                </rn:condition>
                <li><a href="/app/dealer/account/notif/list#rn:session#">#rn:msg:MANAGE_YOUR_NOTIFICATIONS_LBL#</a></li>
