<rn:meta title="#rn:msg:QUESTION_SUBMITTED_LBL#" template="dealer_header.php" clickstream="incident_confirm"/>
<?php
$CI=&get_instance();
$CI->load->helper('report');
$contact_id=$CI->session->getProfileData("c_id");
checkCustomerType('dealer');
$ci_id = \RightNow\Utils\Url::getParameter('i_id');
$incident = RightNow\Connect\v1_3\Incident::fetch($ci_id);
$contactguy=RightNow\Connect\v1_3\Contact::fetch($contact_id);
if($contactguy->ContactType->ID == 2){
$incident->CustomFields->c->channel=187;
$incident->save();
}
?>
<div class="rn_Hero">
...
<div class="rn_PageContent rn_AskQuestion rn_Container">
    <p>
        ...
        <b>
            ...
            <rn:condition_else/>
                <a href="/app/dealer/#rn:config:CP_INCIDENT_RESPONSE_URL#/i_id/#rn:url_param_value:i_id##rn:session#">#<rn:field name="Incident.ReferenceNumber" /></a>.
            </rn:condition>
        </b>
    </p>
    <p>
    ...
    <p>
        ...
        <a href="/app/dealer/#rn:config:CP_ACCOUNT_ASSIST_URL##rn:session#">#rn:msg:ACCOUNT_ASSISTANCE_LBL#</a>
    </p>
    </rn:condition>
</div>
