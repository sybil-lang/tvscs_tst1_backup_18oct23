...
<div class="rn_PageContent rn_AskQuestion rn_Container">
	<div class="col-sm-8">
		<form id="rn_QuestionSubmit1" method="post" action="/cc/ajaxRequest/sendForm" enctype="multipart/form-data">
...
<script>
	$(document).ready(function() {
		...
		// Remove all event listeners from the form and the submit button
		// $('#rn_QuestionSubmit, #rn_FormSubmit_35_Button').off();
		// $("#rn_QuestionSubmit").valid({
		...
		// $('#rn_QuestionSubmit1').validate();

		// $('#rn_FormSubmit_35_Button').click(function(event) {
		// 	if ($("#rn_QuestionSubmit1").valid()) {
		// 		alert('hello - valid form');
		// 		// $('#rn_QuestionSubmit').submit();
		// 	} else {
		// 		alert('hello - NOTvalid form');
		...
		$("#rn_QuestionSubmit1").validate({
			...
			submitHandler: function(form) {
				...
				console.log("this is formdata", formData1);
		...
		// 	} else {
		// 		alert("Hello - Not Valid Form");
		// 		event.preventDefault(); // prevent the form from submitting if it's not valid
		// 	}
		// });

		// $('#rn_FormSubmit_35_Button').submit(function(event) {
	...
	$(document).ready(function() {
		const form1 = document.getElementById("rn_QuestionSubmit1");
		$('#rn_FormSubmit_35_Button').on('click', function(e) {

			const formData1 = new FormData(form1);
			console.log('here', formData1);
