...
<div class="rn_PageContent rn_AccountOverview rn_Container_dash">
	...
	<div id="page">
        ...
        <div id="tabbed-nav2" >
            ...
            <!-- Content container -->
            <div>
                <div data-content-url='<?php echo $site_url;?>/app/employee/dealer_sales_incentive_details''></div>
                <div data-content-url='<?php echo $site_url;?>/app/employee/dealer_collection_incentive_details'></div>
            </div>
