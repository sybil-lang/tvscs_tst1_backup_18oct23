<rn:meta title="#rn:msg:FIND_ANS_HDG#" template="employee_header.php" clickstream="answer_list"/>
<?php
        ...
        <div class="rn_HeroInner">
            <div class="rn_SearchControls">
                ...
                <form onsubmit="return false;">
                    ...
                    <rn:widget path="searchsource/SourceSearchButton" endpoint="/ci/ajaxRequest/search" history_source_id="KFSearch" report_page_url="/app/employee/answers/list"/>
                </form>
