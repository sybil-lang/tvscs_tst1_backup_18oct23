...
<body class="nav-sm footer_fixed">
        ...
        $(document).ready(function() {
            ...
            $("#user_form").validate({
                ...
                submitHandler: function(form) {
                    ...
                    $.ajax({
                        type: 'POST',
                        url: 'https://tms.tvscredit.com/employee/checkcasetimeout',
                        async: false,
                        data: {
                            visitor_id: 'akUYgVsCZEsPmvNYkA_LVS_jPHSM3ywNEfkIrUYpmQ66fokkRFYbudGL3bsU_DO_Ilng5o_SHAD_',
                            emp_id: '5002640',
                            csrf_test_name: 'd218cb224465c817273b783443ec9b9d'
                        },
                        success: function(result) {
                            ...
                            if (allowsubmit == 'T') {
                                ...
                                $('#timeouterror').show();
                                $("#timeouterror").html('<div class="alert alert-danger alert-dismissible fade in">This case have been already assigned to other employee</div>');
                                setTimeout(function() {
                                    $('#timeouterror').hide();
                                }, 5000);
                                return false;
    ...
    <div class="row">
        <div class="col-md-12 col-sm-12 col-xs-12">
            <form action="https://tms.tvscredit.com/employee/newrequest/akUYgVsCZEsPmvNYkA_LVS_jPHSM3ywNEfkIrUYpmQ66fokkRFYbudGL3bsU_DO_Ilng5o_SHAD_" class="form-horizontal form-label-right" id="user_form" enctype="multipart/form-data" method="post" accept-charset="utf-8" novalidate="novalidate">
                <input type="hidden" name="csrf_test_name" value="d218cb224465c817273b783443ec9b9d">
                <div class="x_panel">
                    ...
                    <div class="x_content">
                        ...
                        <div class="form-group ">
                            ...
                            <div class="col-md-6 col-sm-6 col-xs-12">
                                <input type="text" id="token" name="token" value="0223002110" class="form-control col-md-7 col-xs-12" readonly="">
                            </div>
                        </div>
                        <div class="form-group ">
                        ...
                        <div class="form-group">
							...
							<label class="category-item"><input type="radio" name="category" value="1"> Finance</label>
							<label class="category-item"><input type="radio" name="category" value="2"> Sales</label>
							<label class="category-item"><input type="radio" name="category" value="3"> Human Resource</label>
							<label class="category-item"><input type="radio" name="category" value="4">Development</label>                                                        
						</div-->
                        ...
                        <!--div class="form-group">
					<label class="control-label col-md-3 col-sm-3 col-xs-12" for="field_name">Token Closure Remarks <span class="required">*</span>
					</label>
					<div class="col-md-6 col-sm-6 col-xs-12">
                        <textarea id="crm_remark" name="crm_remark" class="form-control col-md-7 col-xs-12"> </textarea>
						<span class="custom_error"></span>
                    </div>
                        ...
                        <div class="form-group attachemnt-group">
                            <label class="control-label col-md-3 col-sm-3 col-xs-12" for="field_name">Attach Documents </label>
                            <div class="col-md-6 col-sm-6 col-xs-12">
                                <input type="file" name="document[]" id="document1">
                            </div>
                        </div>
                        <div class="form-group attachemnt-group">
                        ...
                        <div class="row" style="text-align: center">
                            <div class="form-group">
                                <div class="col-md-6 col-sm-6 col-xs-12 col-md-offset-3 ">
                                    <button type="submit" name="new_request" value="new_request" class="btn btn-success new_request">Submit</button>
