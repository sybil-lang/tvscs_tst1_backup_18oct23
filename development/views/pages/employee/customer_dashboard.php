        ...
        <li><a href="<?php echo $site_url; ?>/app/employee/dealer_disbursal_detail"><span class="glyphicon glyphicon-calendar"></span> Sales Performance <span class="badge pull-right">42</span></a></li>-->
							<li>
								...
								<div class="collapse" id="toggleDemo2" style="height: 0px;">
									<ul class="nav nav-list">
										...
										<li><a href="<?php echo $site_url; ?>/app/employee/selfserviceview">Customer one view</a></li>
									</ul>
								</div>
							</li>
							<!-- hi -->
          ...
          <div class="collapse" id="toggleDemo3" style="height: 0px;">
            <ul class="nav nav-list">
				...
				<div>
					<ul>
						<li style="margin-top:10px;"><a href="<?php echo $site_url; ?>/app/employee/customerquery"><img src="<?php echo $site_url; ?>/euf/assets/themes/standard/images/for-customer-img.gif"></a></li>
					</ul>
				</div>
			</div>
		</div>
