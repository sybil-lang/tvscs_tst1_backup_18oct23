								...
								<p style="padding-top:10px !important;float:right;">
									...
									//$(function() {
										...
										function cb(start, end) {
											var url = "/cc/EmployeeCustom/getTADataList?startDate="+start.toISOString()+"&endDate="+end.toISOString();
...
<script type="text/javascript">
			 ddtable = $('#ta_list').DataTable( {
						 "ajax": {
								url: "/cc/EmployeeCustom/getTADataList",
								dataSrc: "",
								method: 'post',
								data: param
							},
