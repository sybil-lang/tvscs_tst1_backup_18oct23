...
<body>
		...
		<?php 
		if(date("m") >3){?>
			<input type="hidden" name="hfyear1" id="hfyear1" value="<?php echo date('d/m/Y', mktime(0,0,0,date("m")-3,1,date("Y")));?>" />
		<?php }else{?>
			<input type="hidden" name="hfyear1" id="hfyear1" value="<?php echo date('d/m/Y', mktime(0,0,0,date("m"),1,date("Y")));?>" />
		<?php } ?>
...
updateDisbursalData($('#datetimepicker_14 input').val(),$('#datetimepicker_15 input').val(),dealercode);
