...
<script>
    ...
    //     // alert()
    //     // alert(localStorage.getItem('customer_name'))
    //     // alert(localStorage.getItem('subject'))


    // };
    const placeholderValue = localStorage.getItem('agreement_number');
    ...
    document.getElementById('subject').placeholder = localStorage.getItem('subject');
    document.getElementById('customerName').placeholder = localStorage.getItem('customer_name');
    ...
    $(document).ready(function() {
        ...
        //         const removeBtn = fileElem.querySelector('.remove-btn');
        //         removeBtn.addEventListener('click', function() {
        //             fileList.removeChild(fileElem); // Remove the file element from the list
