    ...
    <script>
      $(document).ready(function() {
        ...
        $('#search').click(function() {
          ...
          $('#a_page_show').attr('onclick', 'page_show_search()');
        });
      ...
      var page_number = 1; //number of page
      var page_number_search = 1; //number of page of search
      var total_page;
      var totalpage;
      ...
      function generatetable() {
        ...
        $.post("/cc/AjaxCustom/GetTokenListApiForTmsDashboard", {
          ...
          try {
            ...
            const total_records = main_data['ReturnOutput'].length; //total number of records coming from the API response
        ...
        $.ajax({
          ...
          success: function(response) {
            ...
            if (response_data["ReturnMessage"] == "No Data Found.") {
              ...
              const totalrecords = response_data['ReturnOutput'].length; //total number of records coming from the API response
              ...
              if (endindex > totalrecords) {
                endindex = response_data['ReturnOutput'].length;
    ...
    <div style="border:1px solid #E6E9ED; padding: 8px 20px 15px 20px; ">
      ...
      <form name="form" id="form">
        ...
        <div class="col" style="display:flex;">
          ...
          <button type="button" class="btn" id="search" onclick="SearchByCat()">Search</button>
