    ...
    <head>
      ...
      <script>
        $(document).ready(function() {
          ...
          $.post("/cc/AjaxCustom/GetTokenListApiForTmsDashboard", {
            ...
            try {
              ...
              var main_data = JSON.parse(somedata); // Your data array
              var currentPage = 1; // Current page number

              generateTable(main_data, currentPage); //generate function call
        ...
        function generateTable(data, page) {
          console.log("hihihi",typeof(data));
          var pageSize = 20; // Number of records per page
          ...
          for (i = 0; i < 3500; i++) {
            ...
            html += "<tr><td>" + i + "</td><td>" + data['ReturnOutput'][i]['Token'] + "</td><td>" + data['ReturnOutput'][i]['TokenRequestId'] + "</td><td>" + data['ReturnOutput'][i]['ServiceRequestId'] + "</td><td>" + data['ReturnOutput'][i]['LeadId'] + "</td><td>" + data['ReturnOutput'][i]['CustomerName'] + "</td><td>" + data['ReturnOutput'][i]['EMail'] + "</td><td>" + data['ReturnOutput'][i]['Mobile'] + "</td><td>" + data['ReturnOutput'][i]['AlternateMobile'] + "</td><td>" + data['ReturnOutput'][i]['AgreementNumber'] + "</td><td>" + data['ReturnOutput'][i]['CustomerType'] + "</td><td>" + data['ReturnOutput'][i]['CaseStatus'] + "</td><td>" + data['ReturnOutput'][i]['CreatedDate'] + "</td><td>" + data['ReturnOutput'][i]['UserId'] + "</td><td>" + data['ReturnOutput'][i]['UserName'] + "</td><td>" + data['ReturnOutput'][i]['AssignedTo'] + "</td><td>" + data['ReturnOutput'][i]['AssignedDate'] + "</td><td>" + data['ReturnOutput'][i]['Action'] + "</td></tr>";
          }
