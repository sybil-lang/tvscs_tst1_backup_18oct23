...
//		}
	...
	//	$( "#rn_submitform" ).click(function() {
         ...
         function soa(val)
            {
                ...
                var cat=document.getElementById('rn_ProductCategoryInputEmpCustomer_31_Button_Visible_Text').innerHTML;
        ...
        $('#rn_empFormSubmit_33_Button').on('click',function(e)
        {
					         e.preventDefault();
					         var cat=document.getElementById('rn_ProductCategoryInputEmpCustomer_31_Button_Visible_Text').innerHTML;
					         var a=$('#agreement_no').val().split('#')
					         ...
					         var Question=document.getElementById('rn_TextInput_30_Incident.Threads').value;
...

			           {
													                    ...
													                    {
													                    submit_variable=0;
													                    $('#rn_empFormSubmit_33_Button').submit();
													                    submit_variable=1;
													                    die();  
													                    }
...
function agg_reload()
        {
            ...
            if(test)
            {
                ...
                var cat=document.getElementById('rn_ProductCategoryInputEmpCustomer_31_Button_Visible_Text').innerHTML="";
					         ...
					         document.getElementById('rn_TextInput_30_Incident.Threads').value="";
