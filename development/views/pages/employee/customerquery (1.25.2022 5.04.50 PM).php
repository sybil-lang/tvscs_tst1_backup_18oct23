...
$(document).ready(function(){
	...
	$('#rn_SelectionInput_30').addClass("hidden");
	$('#rn_TextInput_32').addClass("hidden");
	...
	$('button[type="submit"]').click(function(e){
        ...
        if (value=="253") //new address
       {
       	$('#messageTerm').removeClass("hidden");
			...
			$('#pincode').attr("required",true);
       		...
       		$('textarea[name="Incident.CustomFields.c.dispatchaddress"]').attr("maxlength",500);
       		$('#rn_TextInput_32_Label').html("Dispatch Address <span id='attachreq'></span>");
  	...
  	$('#rn_ProductCategoryInputEmpCustomer_35_Button_Visible_Text').on('DOMSubtreeModified',function(){
        ...
        document.getElementsByName('Incident.CustomFields.c.dispatchaddress')[0].value="";
  		...
  		if(categories.includes(sel_val.trim()) == true){
  			...
  			$('#rn_SelectionInput_30').removeClass("hidden");
			$('#rn_TextInput_32').removeClass("hidden");
   ...
   //$('select[name="Incident.CustomFields.c.preferred_address"]').val(254).change();
         ...
         function soa(val)
            {
                ...
                var cat=document.getElementById('rn_ProductCategoryInputEmpCustomer_35_Button_Visible_Text').innerHTML;
                if(cat=="Insurance renewal request")
										    {
										    	cat=77;
        ...
        $('#rn_empFormSubmit_37_Button').on('click',function(e)
        {
					         ...
					         var a=$('#agreement_no').val().split('#')
					         var ag_no="_"+a[2];
					         var address=document.getElementById('rn_SelectionInput_30_Incident.CustomFields.c.preferred_address').value;
					         var daddress=document.getElementById('rn_TextInput_32_Incident.CustomFields.c.dispatchaddress').value;
					         var pin=document.getElementById('pincode').value;
					         var Question=document.getElementById('rn_TextInput_34_Incident.Threads').value;
...
function agg_reload()
        {
            ...
            if(test)
            {
                ...
                var cat=document.getElementById('rn_ProductCategoryInputEmpCustomer_35_Button_Visible_Text').innerHTML="";
					         ...
					         // document.getElementById('rn_SelectionInput_30_Incident.CustomFields.c.preferred_address').value="";
					         // document.getElementById('rn_TextInput_32_Incident.CustomFields.c.dispatchaddress').value="";
					         // document.getElementById('pincode').value="";
					         document.getElementById('rn_TextInput_34_Incident.Threads').value="";
