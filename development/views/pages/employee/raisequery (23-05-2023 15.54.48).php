...
<script>
	...
	$(document).ready(function() {
		...
		// 	var cat = document.getElementById('rn_ProductCategoryInputEmpCustomer_29_Category_Button').value;
        //    var ag_no = document.getElementById('agreement_no').value;

		//    console.log("category is",cat);
		//    console.log("agremeent is",ag_no);
		// })
	})
</script>