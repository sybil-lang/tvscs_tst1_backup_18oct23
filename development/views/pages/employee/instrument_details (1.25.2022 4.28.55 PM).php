					 ...
					 $.post( "/cc/AjaxCustom/RCIMAGE", {ag_no : id} )
																		 .done(function( data ) 
																		 {
																		 	...
																		 	if(data=="true")
																		 	{
	                                                                        	...
	                                                                        	var url='https://customeroperationapi.tvscredit.com/GetData/RCImage_Download?ApplicationNo='+id2//id
...
$('a#url_for_n_soa').click(function(e){
	      ...
	      $.post( "/cc/EmployeeCustom/soa_download_for_emp", { agg_no:agg_no})
	      .done( function( data ) 
	      {
