...
<rn:condition logged_in="false"> -->
			<!--<p><a href="/app/#rn:config:CP_ACCOUNT_ASSIST_URL##rn:session#">#rn:msg:FORGOT_YOUR_USERNAME_OR_PASSWORD_MSG#</a></p>-->
			 ...
			 <div class="rn_StandardLogin">
              ...
              <rn:widget path="custom/login/LoginOtp/" redirect_url="/app/account/profile"  disable_password ="true" initial_focus="true"/>
</div>
		</div>
...
<?php
    ...
    $url = $msg->Value;
    if(getUrlParm("redirect")!= null){
    	header("Location:  /app/utils/login_form");
    }
