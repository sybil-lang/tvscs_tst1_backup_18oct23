<rn:meta title="#rn:msg:FIND_ANSWERS_AND_DISCUSSIONS_LBL#" template="standardMSME.php" clickstream="answer_list"/>
    ...
    <div class="rn_PageContent rn_ResultList">
        ...
        <div class="rn_QuestionResults">
            <rn:container source_id="SocialSearch" per_page="5">
                <rn:widget path="searchsource/SourceResultDetails"/>
                <rn:widget path="searchsource/SocialResultListing" label_heading="#rn:msg:RESULTS_FROM_THE_COMMUNITY_LBL#" more_link_url="/app/msme/social/questions/list"/>
            </rn:container>
        </div>
    </div>
