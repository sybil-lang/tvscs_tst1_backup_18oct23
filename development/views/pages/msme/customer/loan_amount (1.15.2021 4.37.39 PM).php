...
<rn:widget  path="custom/Loan/LoanSelection" />
...
<script type="text/javascript">
									$.post( "/cc/AjaxCustom/rest_api_report", { id_of_report : '<?php echo $report_id;?>' , filtering_val : 'initialloan', method_val : 'initialloanamount'})
													 .done(function( data ) {
												 $( "#select_loanamount" ).html(data);
										 });

                                    // for prospect no select              
                                    // $.post( "/cc/AjaxCustom/rest_api_report", { id_of_report : '<?php echo $report_id;?>' , filtering_val : 'initialloan2', method_val : 'initialloanamount'})
                                    //                  .done(function( data ) {
