...
<style type="text/css">
    ...
    @media screen and (max-width: 480px) {
        ...
        input[type=file], input[type=text],#LoginAgrMobile,#RefMobile,#refName{
            color:#777 !important;
            width: 80% !important;
        } 
...
<div class="rn_PageContent rn_AccountOverview rn_Container_dash">
	...
	<div id="page">
        ...
        <div id="tabbed-nav2">
            ...
            <!-- Content container -->
            <div>
                <!-- <div data-content-url='<?php echo $site_url;?>/app/msme/customer/value-added-service'></div> -->
                <div data-content-url='<?php echo $site_url;?>/app/msme/customer/mgm-service'></div>
				<div data-content-url='<?php echo $site_url;?>/app/msme/customer/mgm-details'></div>
            </div>
