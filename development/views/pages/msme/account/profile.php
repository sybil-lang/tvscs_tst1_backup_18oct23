<rn:meta title="#rn:msg:ACCOUNT_OVERVIEW_LBL#" template="standardMSME.php" login_required="true" force_https="true" clickstream="profile"/>
<div class="rn_Hero">
...
<?php
 ...
 if(strlen($contact_id)>0)
 {
  ...
  header("Location: /app/msme/error404");
 }
?>
<style type="text/css">
  label{
...
<div class="left-half col-lg-6 col-md-6 col-sm-4 col-xs-12">
    ...
    <div class="form-group">
      <label for="pwd">Mobile Number: <span>*</span></label>
...
<div class="right-half col-lg-6 col-md-6 col-sm-4 col-xs-12">
    ...
    <label>Preferred Communication Mode for Payment Updates <span>*</span></label>
    <br>
    <div>
    ...
    <label>Preferred Communication Mode for Promotional updates <span>*</span></label>
    <br>
    ...
    <div class="dropdown">
      <label for="sel1">Preferred Language of Communication <span>*</span></label>
   ...
   <div class="dropdown">
        <label for="sel2">Preferred Time for Receiving Communication <span>*</span></label>
