<rn:meta title="#rn:msg:NOTIFICATIONS_HDG#" template="standardMSME.php" login_required="true" force_https="true"/>
<div class="rn_Hero">
...
<div class="rn_PageContent rn_AccountNotifications rn_Container">
    ...
    <rn:widget path="notifications/ProdCatNotificationManager" report_page_url="/app/msme/#rn:config:CP_PRODUCTS_DETAIL_URL#" />
