<rn:meta title="#rn:msg:CHANGE_YOUR_PASSWORD_CMD#" template="standardMSME.php" login_required="true" force_https="true"/>
...
<div class="rn_PageContent rn_Account rn_Container">
    ...
    <form id="rn_ChangePassword" onsubmit="return false;">
        ...
        <rn:widget path="input/FormSubmit" on_success_url="#rn:php:'/app/msme/account/profile/msg/' . urlencode(\RightNow\Utils\Config::getMessage(YOUR_PASSWORD_HAS_BEEN_CHANGED_MSG))#" error_location="rn_ErrorLocation" />
    </form>
</div>
