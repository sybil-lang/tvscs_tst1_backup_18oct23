...
<div class="rn_PageContent rn_AccountOverview rn_Container">
    <div class="rn_ContentDetail">
        ...
        <div class="rn_Well">
            ...
            <ul>
                <li><a href="/app/msme/account/profile#rn:session#">#rn:msg:UPDATE_YOUR_ACCOUNT_SETTINGS_CMD#</a></li>
                <rn:condition external_login_used="false">
                    <rn:condition config_check="EU_CUST_PASSWD_ENABLED == true">
                        <li><a href="/app/msme/account/change_password#rn:session#">#rn:msg:CHANGE_YOUR_PASSWORD_CMD#</a></li>
                    </rn:condition>
                </rn:condition>
                <li><a href="/app/msme/account/notif/list#rn:session#">#rn:msg:MANAGE_YOUR_NOTIFICATIONS_LBL#</a></li>
                <rn:condition is_active_social_user="true">
                        <li><a href="/app/msme/public_profile/user/#rn:profile:socialUserID#">#rn:msg:VIEW_YOUR_PUBLIC_PROFILE_LBL#</a></li>
                </rn:condition>
            </ul>
        </div>
    </div>
    ...
    <div class="rn_ContentDetail">
        <div class="rn_Questions">
            <rn:container report_id="196" per_page="4">
                <div class="rn_HeaderContainer">
                    <h2><a class="rn_Questions" href="/app/msme/account/questions/list#rn:session#">#rn:msg:MY_SUPPORT_QUESTIONS_LBL#</a></h2>
                </div>
