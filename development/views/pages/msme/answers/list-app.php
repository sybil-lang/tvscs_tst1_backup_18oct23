<rn:meta title="#rn:msg:FIND_ANS_HDG#" template="standard_app.php" clickstream="answer_list"/>
...
<rn:condition url_parameter_check="kw != null">
        ...
        <div class="rn_HeroInner">
            <div class="rn_SearchControls">
                ...
                <form onsubmit="return false;">
                    ...
                    <rn:widget path="searchsource/SourceSearchButton" endpoint="/ci/ajaxRequest/search" history_source_id="KFSearch" report_page_url="/app/msme/answers/list"/>
                </form>
    ...
    <div class="rn_Container">
     ...
     <!--   <aside class="rn_SideRail" role="complementary">
            ...
            <rn:widget path="searchsource/SummaryResultListing" label_heading="#rn:msg:COMMUNITY_RESULTS_LBL#" results_type="SocialQuestions" more_link_url="/app/msme/social/questions/list" per_page="10"/>
        </aside>-->
    </div>
<rn:condition_else/>
    ...
    <div class="rn_Container">
        <div class="rn_PageContent rn_KBAnswerList">
            ...
            <div>
                ...
                <rn:widget path="custom/reports/answersMultiline" hide_columns="answers.updated"/>
