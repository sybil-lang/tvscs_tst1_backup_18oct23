<rn:meta title="#rn:msg:QUESTION_SUBMITTED_LBL#" template="standardMSME.php" clickstream="incident_confirm"/>
<?php
$CI=&get_instance();
...
<div class="rn_PageContent rn_AskQuestion rn_Container">
    <p>
        ...
        <b>
            ...
            <rn:condition_else/>
                <a href="/app/msme/#rn:config:CP_INCIDENT_RESPONSE_URL#/i_id/#rn:url_param_value:i_id##rn:session#">#<rn:field name="Incident.ReferenceNumber" /></a>.
            </rn:condition>
        </b>
    </p>
    <p>
    ...
    <p>
        ...
        <a href="/app/msme/#rn:config:CP_ACCOUNT_ASSIST_URL##rn:session#">#rn:msg:ACCOUNT_ASSISTANCE_LBL#</a>
    </p>
    </rn:condition>
</div>
