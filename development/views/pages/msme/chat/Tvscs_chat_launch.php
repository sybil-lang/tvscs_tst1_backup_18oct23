<rn:meta title="#rn:msg:LIVE_CHAT_LBL#" template="Tvscs_chat_standard.php" clickstream="chat_request"/>
<link rel="stylesheet" href="/euf/assets/themes/standard/css/tvs-chat.css"/>
<!--<div class="rn_Hero">
...
<div id="rn_PageContent" class="rn_Live rn_Container">
    ...
    <div id="rn_ChatLaunchFormDiv" class="rn_ChatForm">
        ...
        <form id="rn_ChatLaunchForm" method="post" action="/app/msme/chat/chat_landing">
