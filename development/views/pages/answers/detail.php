...
?>
<rn:meta title="#rn:php:\RightNow\Libraries\SEO::getDynamicTitle('answer', \RightNow\Utils\Url::getParameter('a_id'))#" template="standardlogincust.php" answer_details="true" clickstream="answer_view"/>
