...
<script type="text/javascript">
      var mobile="";
        ...
        function die()
        {
         ...
         function soa(val)
            {
                var cat=document.getElementById('rn_askCategoryInput_38_Incident.Category').value;
        ...
        $('#rn_submitform').on('click',function(e)
        {
         ...
         var Question=document.getElementById('rn_TextInput_37_Incident.Threads').value;
...
function agg_reload()
        {
            ...
            if(test)
            {
                ...
                document.getElementById("rn_TextInput_37_Incident.Threads").value='';
                // document.getElementById("rn_TextInput_40_Incident.CustomFields.c.dispatchaddress").value='';

                
                document.getElementById("rn_askCategoryInput_38_Incident.Category").value='';
