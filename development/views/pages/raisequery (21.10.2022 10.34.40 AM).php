    ...
    function NocRequest_CheckLive(mobile, ag_no) {
        ...
        $.ajax({
            ...
            success: function(data) {
                ...
                console.log('datat from nocLiveCheck api   ', JSON.parse((dataAAA.RequestNOCResponse.RequestNOCResult))); // Resolve promise and go to then()
    ...
    $(document).ready(function() {
                $('#rn_submitform').on('click', function(e) {
                            ...
                            if ((cat == 53 || cat == 84 || cat == 1891 || cat == 1812 || cat == 86 || cat == 93 || cat == 77 || cat == 1812 || cat == 56 || cat == 82 || cat == 58) && ag_no) {
                                if (cat && ag_no && address && daddress && pin && Question && subjectt) {} else {
                        ...
                        document.getElementById("rn_agreementSelect_29_Incident.CustomFields.CO.Loan.ID").addEventListener("change", agg_reload); document.getElementById("rn_agreementSelect_29_Incident.CustomFields.CO.Loan.ID").addEventListener("click", agg_val);
</script>