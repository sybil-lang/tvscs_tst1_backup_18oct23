          ...
          if ($isActive) {
            ...
            if (($loanType == "Retail" || $loanType == null || $loanType == "Both") && $submit_div_id == "rn_LoginOtp_6_Submit") {
              ...
              // } 
                ...
                return $this->getResponseObject("Invalid Password. Try again.", 'is_string');
              }
        ...
        if (strlen($contact_id) and $contact_id > 0) {
          ...
          if ($isActive) {
            ...
            if (($loanType == "Retail" || $loanType == null || $loanType == "Both") && $submit_div_id == "rn_LoginOtp_6_Submit") {
              ...
              // if (($password == $otp && $currentdatetime <= $enddatetime)) { //commented the adjacnet line & wrote below line for otp disbalment & custom pwd
                if (($password == "12345@abc")) {
                //loggedin
                //  $profile = Api::contact_login($pairData);
                // echo "good".$loanType;
