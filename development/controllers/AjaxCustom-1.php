...
*/
    ...
    */
    ...
    function OTP_PhoneChange()
    {
        ...
        curl_setopt_array($curl, array(
            CURLOPT_URL => 'https://sms.tvscredit.com/smssend/token',
            CURLOPT_RETURNTRANSFER => true,
            CURLOPT_ENCODING => '',
            CURLOPT_MAXREDIRS => 10,
            CURLOPT_TIMEOUT => 0,
        ...
        curl_setopt_array($curl, array(
            CURLOPT_URL => 'https://sms.tvscredit.com/smssend/sendSms?Lang=EN&Phone=' . $mobile . '&Purpose=1641&Template=TIncident_AcknowledgementIT2855&EmpId=AIncident_AcknowledgementIT1583&Msg=' . $msg,
            CURLOPT_RETURNTRANSFER => true,
            CURLOPT_ENCODING => '',
            CURLOPT_MAXREDIRS => 10,
            CURLOPT_TIMEOUT => 0,
        ...
        // curl_setopt_array($curl, array(
        // CURLOPT_URL => 'https://sms.tvscredit.com/smssend/sendSms?Lang=EN&Phone=' . $mobile . '&Purpose=1541&Template=TCUSTOMER_NUMBER_UPDATECustomer%20Service3415&EmpId=ACUSTOMER_NUMBER_UPDATECustomer%20Service1483&Msg=' . $msg,
        // CURLOPT_RETURNTRANSFER => true,
        // CURLOPT_ENCODING => '',
        // CURLOPT_MAXREDIRS => 10,
        // CURLOPT_TIMEOUT => 0,
...
curl_setopt_array($curl, array(
  ...
  CURLOPT_HTTPHEADER => array(
    'Authorization: Basic SVZSVVNSOklWUlVTUiQ=',
    'Cookie: JSESSIONID=VdrAZYeIF0OB12ulJQW0-RuMqoyHRvboYhdwFYGX.csdcapps9'
  ),
));
