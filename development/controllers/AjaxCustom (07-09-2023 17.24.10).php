...
class AjaxCustom extends \RightNow\Controllers\Base
{
    ...
    function initialloanamount_accordin()
    {
        ...
        // curl_close($curl);
        // echo $response;
        //  https://msmeportaluatoci.tvscredit.com/MSMEServices/application/getApplicationDetails?custId=17362301&mobNo=9842444777
        $curl = curl_init();

        curl_setopt_array(
            $curl,
            array(
                CURLOPT_URL => 'https://msmeportaluatoci.tvscredit.com/MSMEServices/application/getApplicationDetails?custId=' . $customerID . '&mobNo=' . $mobile,
                CURLOPT_RETURNTRANSFER => true,
                CURLOPT_ENCODING => '',
                CURLOPT_MAXREDIRS => 10,
                CURLOPT_TIMEOUT => 0,
