...
',
    ...
    function cdmobileunlock(){
      ...
      $pass = $_POST['passkey'];
        ...
        curl_setopt_array($curl, array(
        CURLOPT_URL => 'https://appsuat.tvscredit.com/tvs/api/knox?data=%7B%22name%22:%22getKnoxAndDcUnlockOfflinePin%22,%22accessKey%22:%225dfd585c8f4264333a6baa3df9afc3fd454bd1c5042533abaf865454caa8abcsk%22,%22agmtNumber%22:%22'.$ag_no.'1%22,%22challenge%22:%22'.$pass.'%22%7D',
        CURLOPT_RETURNTRANSFER => true,
        CURLOPT_ENCODING => '',
        CURLOPT_MAXREDIRS => 10,
        CURLOPT_TIMEOUT => 0,
    ...
    function outstanding_verification(){
        ...
        curl_setopt_array($curl, array(
        CURLOPT_URL => 'https://ivrchatbotrestuat.tvscredit.com/IVRCHATBOT/IVR/LoanDetails/LoanBalEnquiry',
        CURLOPT_RETURNTRANSFER => true,
        CURLOPT_ENCODING => '',
        CURLOPT_MAXREDIRS => 10,
        CURLOPT_TIMEOUT => 0,
