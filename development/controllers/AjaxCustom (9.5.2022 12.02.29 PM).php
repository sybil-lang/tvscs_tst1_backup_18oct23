                        ...
                        $(document).ready(function ()
                        {
                           ...
                           $('#i_loan').change(function()
                           {
                                if($(this).val()!='0')
                            {
                              ...
                              var d= $(this).val(); 
                              $.post( "/cc/AjaxCustom/rest_api_call_drop2", {ag_no : d , method_val : '<?php echo $methodval;?>'})
                                                                         .done(function( data ) 
                             {
                         ...
                         $('#s_loan').trigger('change'); //This event will fire the change event. 
                           $('#s_loan').change(function()
                           {
                                if($(this).val()!='0')
                            {
                              ...
                              var x= $(this).val(); 
                                $.post( "/cc/AjaxCustom/rest_api_call_drop2", {ag_no : x , method_val : '<?php echo $methodval;?>'})
                                                                         .done(function( data ) {
                        ...
                        var isSoaOk = true;
                           ...
                           $('#i_detail').change(function()
                           {
                                if($(this).val()!='0')
                            {
                              ...
                              var id= $(this).val(); 
                              $.post("/cc/AjaxCustom/check_soa_permission",{ag_no:id}).done(function(data){
                                ...
                                function(){ 
                              $.post( "/cc/AjaxCustom/rest_api_call_drop2", {ag_no : id , method_val : '<?php echo $methodval;?>'})
                                                                         .done(function( data ) {
                    ...
                    $(document).ready(function (){
                           ...
                           $('#i_detail').change(function()
                           {
                                ...
                                if($(this).val()!='0')
                            {
                             ...
                             $.post( "/cc/AjaxCustom/rest_api_call_drop2", {ag_no : id , method_val : 'getMandateStatuses'})
                             .done(function( data ) {
                        ...
                        $(document).ready(function ()
                        {
                           ...
                           $('#i_loan').change(function()
                           {
                            ...
                            if($(this).val()!='0')
                            {
                                      $('#iload').css("display","block");
                                      var d= $(this).val(); 
                                      $.post( "/cc/AjaxCustom/rest_api_call_drop", {ag_no : d , method_val : '<?php echo $methodval;?>'})
                                                                                 .done(function( data ) 
                                     {
                                            $( "#showresult" ).html(data);
                                            $('#iload').css("display","none");
                           ...
                           $('#edoc_loan').change(function()
                           {
                              ...
                              var x= $(this).val(); 
                                if($(this).val()!='0'){
                                    ...
                                    $.post( "/cc/AjaxCustom/edoc", {ag_no : x , method_val : '<?php echo $methodval;?>'})
                                 .done(function( data ) {
                                    var href_data1="";
                                    var data = JSON.parse(data);
                                    ...
                                    if(data.statusMessage=="Success")
                                    {
                                     ...
                                     $.post( "/cc/AjaxCustom/edoc", {ag_no : x , method_val : 'SANC_EAGRE'})
                                     .done(function( data ) {
                                        var data = JSON.parse(data);
                                         href_data= data.data;
                                    ...
                                    {
                                        // $('#edoc1_s').removeClass('hidden');
                                        document.getElementById('error_msg').innerHTML="The requested E-Document not found"
                         ...
                         $('#s_loan').trigger('change'); //This event will fire the change event. 
                           $('#s_loan').change(function()
                           {
                            ...
                            if($(this).val()!='0'){
                                ...
                                $.post( "/cc/AjaxCustom/rest_api_call_drop", {ag_no : x , method_val : '<?php echo $methodval;?>'})
                                                                         .done(function( data ) {
                                                                     $( "#showresult_loan" ).html(data);
                                    $('#isload').css("display","none");
                                                             });
                         ...
                         // $('#rc_pull').trigger('change'); //This event will fire the change event. 
                           $('#rc_pull').change(function()
                           {
                            ...
                            if($(this).val()!='0')
                            {
                                ...
                                $.post( "/cc/AjaxCustom/rest_api_call_drop", {ag_no : x , method_val : 'rc_pull'})
                                                                         .done(function( data ) {
...
////////////////////////////code for paperlessnoc
                                        // console.log('value',$(this).val())
                                         ...
                                         $.post( "/cc/AjaxCustom/InsuranceRenewalPolicy", {ag_no : id} )
                                     .done(function( data ) 
                                     {
                                       ...
                                       var url='https://customeroperationapi.tvscredit.com/InsuranceRenewal/InsurancecopyRenewalDocuments?AgreementNo='+id//id
                                        ...
                                        else
                                        {
                                            ...
                                            // $("#instrumentdetails_docs").hide();
                                              ...
                                              $.post( "/cc/AjaxCustom/rest_api_call_drop", {ag_no : id , method_val : '<?php echo $methodval;?>'})
                                                                                         .done(function( data ) {
                                                                                     var url_data = JSON.parse(data);
                    ...
                    $(document).ready(function (){
                           ...
                           $('#i_detail').change(function()
                           {
                            ...
                            if($(this).val()!='0'){
                             ...
                             $.post( "/cc/AjaxCustom/rest_api_call_drop", {ag_no : id , method_val : 'getMandateStatuses'})
                             .done(function( data ) {
                                                        var json_response = JSON.parse(data);
                                                        //console.log(json_response);
                                                        // console.log(json_response[0].Agment_NO);
                           ...
                           $('#i_detail').change(function()
                           {
                              $('#isload').css("display","block");
                                ...
                                if($(this).val()!='0'){
                                        ...
                                        $.post( "/cc/AjaxCustom/rest_api_call_drop", {ag_no : id , method_val : 'getMandateLoanStatuses'})
                                         .done(function( data ) 
                                         {
                                            var json_response = JSON.parse(data);
                                            console.log(json_response);
...
{
                       try{ $contact_id=$_POST['contact_id'];
                        $loan_id=$_POST['agg'];
                        $PrimaryContact = \RightNow\Connect\v1_3\Contact::fetch($contact_id);
                        $incident = new \RightNow\Connect\v1_3\Incident();
                        $incident->PrimaryContact = \RightNow\Connect\v1_3\Contact::fetch($contact_id);
...
if($IncidentID)
{
    ...
    $arr= RNCPHP\AnalyticsReport::fetch(100760); //tst  107326
...
function apiHITSfor_digitization()
{
    ...
    elseif($cat==53)
    {
        $url='https://ivrserviceuat.tvscredit.com/ChatBotNew/Dup_NOCRequest_web';
        $msg="Apply NOC";
    }
    elseif($cat==77)
    {
...
// }
    ...
    function update_mobile()
    {
        ...
        curl_setopt_array($curl, array(
          CURLOPT_URL => 'https://lmsrestserviceuat.tvscredit.com/LMSLEADS/chat/updatecontact',
          CURLOPT_RETURNTRANSFER => true,
          CURLOPT_ENCODING => '',
          CURLOPT_MAXREDIRS => 10,
          CURLOPT_TIMEOUT => 0,
    ...
    function noclivecheck()
    {
        ...
        <soap:Envelope xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance" xmlns:xsd="http://www.w3.org/2001/XMLSchema" xmlns:soap="http://schemas.xmlsoap.org/soap/envelope/">
          <soap:Body>
            <RequestNOC xmlns="http://tempuri.org/">
        ...
        curl_setopt_array($curl, array(
          CURLOPT_URL => 'https://botinterfaceuat.tvscredit.com/WebService.asmx?op=RequestNOC',
          CURLOPT_RETURNTRANSFER => true,
          CURLOPT_ENCODING => '',
          CURLOPT_MAXREDIRS => 10,
          CURLOPT_TIMEOUT => 0,
          ...
          CURLOPT_HTTPHEADER => array(
            'Content-Type: text/xml; charset=utf-8text/xml; charset=utf-8'
          ),
        ));
        $response = curl_exec($curl);
        // $xml_cnt = str_replace(array("\n", "\r", "\t"), '', $response);    // removes newlines, returns and tabs
  ...
  // return json_encode($simpleXml); 
        ...
        echo ($response);
            ...
            function invokepl()
            {
                ...
                $curl = curl_init();
                curl_setopt_array($curl, array(
                  CURLOPT_URL => 'https://botinterface.tvscredit.com/WebService.asmx?op=Is_Toupup_Required',
                  CURLOPT_RETURNTRANSFER => true,
                  CURLOPT_ENCODING => '',
                  CURLOPT_MAXREDIRS => 10,
                  CURLOPT_TIMEOUT => 0,
                ...
                <soap:Envelope xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance" xmlns:xsd="http://www.w3.org/2001/XMLSchema" xmlns:soap="http://schemas.xmlsoap.org/soap/envelope/">
                  <soap:Body>
                    <Is_Toupup_Required xmlns="http://tempuri.org/">
                      <AgreementNo>'.$agg[1].'</AgreementNo>
                      <Amount>'.$amount.'</Amount>
                      <Cust_Status>Y</Cust_Status>
                      <AppID>yFyPUcFsqzeYCfyokBaqxA==</AppID>
                    </Is_Toupup_Required>
                  </soap:Body>
                </soap:Envelope>',
