...
// echo $agg[1].$mobile;
    ...
    function BounceNotification()
    {
        ...
        $curl = curl_init();
        curl_setopt_array($curl, array(
          CURLOPT_URL => 'https://ivrservice.tvscredit.com/ChatBotNew/BounceNotification',
          CURLOPT_RETURNTRANSFER => true,
          CURLOPT_ENCODING => '',
          CURLOPT_MAXREDIRS => 10,
          CURLOPT_TIMEOUT => 0,
    ...
    function MandateRejectNotification()
    {
        ...
        $curl = curl_init();
        curl_setopt_array($curl, array(
          CURLOPT_URL => 'https://ivrservice.tvscredit.com/ChatBotNew/MandateRejectNotification',
          CURLOPT_RETURNTRANSFER => true,
          CURLOPT_ENCODING => '',
          CURLOPT_MAXREDIRS => 10,
          CURLOPT_TIMEOUT => 0,
    ...
    function NOCPendingNotification()
    {
        ...
        $curl = curl_init();
        curl_setopt_array($curl, array(
          CURLOPT_URL => 'https://ivrservice.tvscredit.com/ChatBotNew/NOCPendingNotification',
          CURLOPT_RETURNTRANSFER => true,
          CURLOPT_ENCODING => '',
          CURLOPT_MAXREDIRS => 10,
          CURLOPT_TIMEOUT => 0,
    ...
    function MandateSuccessNotification()
    {
        ...
        $curl = curl_init();
        curl_setopt_array($curl, array(
          CURLOPT_URL => 'https://ivrservice.tvscredit.com/ChatBotNew/MandateSuccessNotification',
          CURLOPT_RETURNTRANSFER => true,
          CURLOPT_ENCODING => '',
          CURLOPT_MAXREDIRS => 10,
          CURLOPT_TIMEOUT => 0,
    ...
    function ClearedNotification()
    {
        ...
        $curl = curl_init();
        curl_setopt_array($curl, array(
          CURLOPT_URL => 'https://ivrservice.tvscredit.com/ChatBotNew/ClearedNotification',
          CURLOPT_RETURNTRANSFER => true,
          CURLOPT_ENCODING => '',
          CURLOPT_MAXREDIRS => 10,
          CURLOPT_TIMEOUT => 0,
    ...
    function PNTNotification()
    {
        ...
        $curl = curl_init();
        curl_setopt_array($curl, array(
          CURLOPT_URL => 'https://ivrservice.tvscredit.com/ChatBotNew/PNTNotification',
          CURLOPT_RETURNTRANSFER => true,
          CURLOPT_ENCODING => '',
          CURLOPT_MAXREDIRS => 10,
          CURLOPT_TIMEOUT => 0,
...
curl_setopt_array($curl, array(
  CURLOPT_URL => 'https://ivrservice.tvscredit.com/ChatBotNew/BirthdayNotification',
  CURLOPT_RETURNTRANSFER => true,
  CURLOPT_ENCODING => '',
  CURLOPT_MAXREDIRS => 10,
  CURLOPT_TIMEOUT => 0,
...
curl_setopt_array($curl, array(
  CURLOPT_URL => 'https://ivrservice.tvscredit.com/ChatBotNew/WelcomeLetterNotification',
  CURLOPT_RETURNTRANSFER => true,
  CURLOPT_ENCODING => '',
  CURLOPT_MAXREDIRS => 10,
  CURLOPT_TIMEOUT => 0,
