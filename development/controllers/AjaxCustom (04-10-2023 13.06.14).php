...
class AjaxCustom extends \RightNow\Controllers\Base
{
    ...
    function initialloanamount_accordin()
    {
        ...
        curl_setopt_array(
            $curl,
            array(
                CURLOPT_URL => 'https://msmeportal.tvscredit.com/MSMEServices/application/getApplicationDetails?custId=' . $customerID . '&mobNo=' . $mobile,
                CURLOPT_RETURNTRANSFER => true,
                CURLOPT_ENCODING => '',
                CURLOPT_MAXREDIRS => 10,
                CURLOPT_TIMEOUT => 0,
...
?>
    ...
    function rest_api_report()
    {
        ...
        <?php
        } else if ($_REQUEST['filtering_val'] == 'mandateStatus_ndc') {
            echo "<div class='form-group'><select id='i_detail_s" . $_POST['filter_subloan'] . "'><option value='0'>--Select--</option>";
            foreach ($response as $key => $result) {
                //  if(!empty($userData['agg_no']) && $userData['agg_no'] == $result['Agreement No']){
                //$sel = "selected";
                //$flag = true;
        ...
        ?>
            ...
            <script type="text/javascript">
                $(document).ready(function() {
                    ...
                    $('#i_detail_s').trigger('change');
                    $('#i_detail_s').change(function() {
                        $('#idload').css("display", "block");
            ...
            <!-- for new page digitalnoc created on 29-09-2023  charu -->
        <?php
        } else if ($_REQUEST['filtering_val'] == 'mandateStatus_digitalnoc') {
            echo "<div class='form-group'><select id='i_detail_digitalnoc" . $_POST['filter_subloan'] . "'><option value='0'>--Select--</option>";
            foreach ($response as $key => $result) {
                //  if(!empty($userData['agg_no']) && $userData['agg_no'] == $result['Agreement No']){
                //$sel = "selected";
                //$flag = true;
        ...
        ?>
            ...
            <script type="text/javascript">
                $(document).ready(function() {
                    ...
                    $('#i_detail_digitalnoc').trigger('change');
                    $('#i_detail_digitalnoc').change(function() {
                        $('#idload').css("display", "block");
    ...
    */
    ...
    function GetTokenListApiForTmsDashboard()
    {
        ...
        curl_setopt_array(
            $curl,
            array(
                CURLOPT_URL => 'https://dealerportalservices.tvscredit.com/tmsUAT/api/tmsapi/GetTokenList',
                CURLOPT_RETURNTRANSFER => true,
                CURLOPT_ENCODING => '',
                CURLOPT_MAXREDIRS => 10,
                CURLOPT_TIMEOUT => 0,
...
',
    ...
    function GetTokenCountByStatusForReport()
    {
        ...
        curl_setopt_array(
            $curl,
            array(
                CURLOPT_URL => 'https://dealerportalservices.tvscredit.com/tmsUAT/api/tmsapi/GetTokenCountByStatus',
                CURLOPT_RETURNTRANSFER => true,
                CURLOPT_ENCODING => '',
                CURLOPT_MAXREDIRS => 10,
                CURLOPT_TIMEOUT => 0,
...
',
    ...
    function GetSerachByCategory()
    {
        ...
        curl_setopt_array(
            $curl,
            array(
                CURLOPT_URL => 'https://dealerportalservices.tvscredit.com/tmsUAT/api/tmsapi/GetTokenSearchByCategory',
                CURLOPT_RETURNTRANSFER => true,
                CURLOPT_ENCODING => '',
                CURLOPT_MAXREDIRS => 10,
                CURLOPT_TIMEOUT => 0,
    ...
    function GetTokenDetails()
    {
        ...
        curl_setopt_array(
            $curl,
            array(
                CURLOPT_URL => 'https://dealerportalservices.tvscredit.com/tmsUAT/api/tmsapi/GetTokenDetails',
                CURLOPT_RETURNTRANSFER => true,
                CURLOPT_ENCODING => '',
                CURLOPT_MAXREDIRS => 10,
                CURLOPT_TIMEOUT => 0,
    ...
    function UpdateTokenStatus()
    {
        ...
        curl_setopt_array(
            $curl,
            array(
                CURLOPT_URL => 'https://dealerportalservices.tvscredit.com/tmsUAT/api/tmsapi/UpdateTokenStatus',
                CURLOPT_RETURNTRANSFER => true,
                CURLOPT_ENCODING => '',
                CURLOPT_MAXREDIRS => 10,
                CURLOPT_TIMEOUT => 0,
   ...
   "utm_campaign":""
    ...
    function InsuranceNotification()
    {
        ...
        //api changes on 29 sept2023 by charu


        $curl = curl_init();

        curl_setopt_array($curl, array(
            CURLOPT_URL => 'https://ivrchatbotrestuatoci.tvscredit.com/IVRCHATBOT/notification/InsuranceNotification',
            CURLOPT_RETURNTRANSFER => true,
            CURLOPT_ENCODING => '',
            CURLOPT_MAXREDIRS => 10,
            CURLOPT_TIMEOUT => 0,
...
',
    ...
    function BounceNotification()
    {
        ...
        //api changes on 29-09-2023-charu

        $curl = curl_init();

        curl_setopt_array($curl, array(
            CURLOPT_URL => 'https://ivrchatbotrestuatoci.tvscredit.com/IVRCHATBOT/notification/BounceNotification',
            CURLOPT_RETURNTRANSFER => true,
            CURLOPT_ENCODING => '',
            CURLOPT_MAXREDIRS => 10,
            CURLOPT_TIMEOUT => 0,
...
',
    ...
    function MandateRejectNotification()
    {
        ...
        //api changes on 29 sept2023 by chary


        $curl = curl_init();

        curl_setopt_array($curl, array(
            CURLOPT_URL => 'https://ivrchatbotrestuatoci.tvscredit.com/IVRCHATBOT/notification/MandateRejectNotification',
            CURLOPT_RETURNTRANSFER => true,
            CURLOPT_ENCODING => '',
            CURLOPT_MAXREDIRS => 10,
            CURLOPT_TIMEOUT => 0,
...
',
    ...
    function NOCPendingNotification()
    {
        ...
        //api changes by charu on 29 sept 2023

        $curl = curl_init();

        curl_setopt_array($curl, array(
            CURLOPT_URL => 'https://ivrchatbotrestuatoci.tvscredit.com/IVRCHATBOT/notification/nocPendingNotification',
            CURLOPT_RETURNTRANSFER => true,
            CURLOPT_ENCODING => '',
            CURLOPT_MAXREDIRS => 10,
            CURLOPT_TIMEOUT => 0,
...
',
    ...
    function MandateSuccessNotification()
    {
        ...
        //api changes on 29 sept 2023 by charu
        $curl = curl_init();

        curl_setopt_array($curl, array(
            CURLOPT_URL => 'https://ivrchatbotrestuatoci.tvscredit.com/IVRCHATBOT/notification/MandateSuccessNotification',
            CURLOPT_RETURNTRANSFER => true,
            CURLOPT_ENCODING => '',
            CURLOPT_MAXREDIRS => 10,
            CURLOPT_TIMEOUT => 0,
...
',
    ...
    function ClearedNotification()
    {
        ...
        //api changed on 29 sept2023 by charu
        $curl = curl_init();

        curl_setopt_array($curl, array(
            CURLOPT_URL => 'https://ivrchatbotrestuatoci.tvscredit.com/IVRCHATBOT/notification/clearedNotification',
            CURLOPT_RETURNTRANSFER => true,
            CURLOPT_ENCODING => '',
            CURLOPT_MAXREDIRS => 10,
            CURLOPT_TIMEOUT => 0,
...
',
    ...
    function PNTNotification()
    {
        ...
        curl_setopt_array($curl, array(
            CURLOPT_URL => 'https://ivrchatbotrestuatoci.tvscredit.com/IVRCHATBOT/notification/PntNotification',
            CURLOPT_RETURNTRANSFER => true,
            CURLOPT_ENCODING => '',
            CURLOPT_MAXREDIRS => 10,
            CURLOPT_TIMEOUT => 0,
...
',
    ...
    function nocdispatched()
    {
        ...
        curl_setopt_array($curl, array(
            CURLOPT_URL => 'https://ivrchatbotrestuatoci.tvscredit.com/IVRCHATBOT/ChatBotNew/RequestNOC_EXT',
            CURLOPT_RETURNTRANSFER => true,
            CURLOPT_ENCODING => '',
            CURLOPT_MAXREDIRS => 10,
            CURLOPT_TIMEOUT => 0,
    ...
    function cdmobileunlock()
    {
        ...
        //api change oin 12 march2023-Charu

        // $curl = curl_init();

        // curl_setopt_array($curl, array(
        // CURLOPT_URL => 'https://appsuat.tvscredit.com/tvs/api/knox?data=%7B%22name%22:%22getKnoxAndDcUnlockOfflinePin%22,%22accessKey%22:%225dfd585c8f4264333a6baa3df9afc3fd454bd1c5042533abaf865454caa8abcsk%20%22,%22agmtNumber%22:%22'.$agg.'%22,%22challenge%22:%'.$pass.'%22%7D',
        // CURLOPT_RETURNTRANSFER => true,
        // CURLOPT_SSL_VERIFYPEER => false,
        // CURLOPT_ENCODING => '',
        // CURLOPT_MAXREDIRS => 10,
        ...
        //commented on -2-08-2023
        // $curl = curl_init();

        // curl_setopt_array(
        //     $curl,
        //     array(
        //         CURLOPT_URL => 'https://appsuat.tvscredit.com/tvs/api/knox?data=%7B%22name%22:%22getKnoxAndDcUnlockOfflinePin%22,%22accessKey%22:%225dfd585c8f4264333a6baa3df9afc3fd454bd1c5042533abaf865454caa8abcsk%22,%22agmtNumber%22:%22' . $ag_no . '%22,%22challenge%22:%22' . $pass . '%22%7D',
        //         CURLOPT_RETURNTRANSFER => true,
        //         CURLOPT_ENCODING => '',
        //         CURLOPT_MAXREDIRS => 10,
        //         CURLOPT_TIMEOUT => 0,
        ...
        curl_setopt_array($curl, array(
            CURLOPT_URL => 'https://appsuat.tvscredit.com/tvs/api/knox?data={%22name%22%3A%22getKnoxAndDcUnlockOfflinePin%22%2C%22accessKey%22%3A%225dfd585c8f4264333a6baa3df9afc3fd454bd1c5042533abaf865454caa8abcsk%22%2C%22agmtNumber%22%3A%22' . $ag_no . '%22%2C%22challenge%22%3A%22' . $pass . '%22}',
            CURLOPT_RETURNTRANSFER => true,
            CURLOPT_ENCODING => '',
            CURLOPT_MAXREDIRS => 10,
            CURLOPT_TIMEOUT => 0,
    ...
    function digitalnoc_paymentlink()
    {
        ...
        curl_setopt_array($curl, array(
            CURLOPT_URL => 'https://paymentreceiptuat.tvscredit.com/receipt/v1/hash1',
            CURLOPT_RETURNTRANSFER => true,
            CURLOPT_ENCODING => '',
            CURLOPT_MAXREDIRS => 10,
            CURLOPT_TIMEOUT => 0,
            ...
            "hashOne": "wrsXWRpRxnU+7mgSOCTPU18Evh1R4P6e1ooB6BMlqKavKLvKjm+wDoj14fxicVcKxkIhc5L5DiPFzwhTHb6P3XLbfvNtQhZuIxlf1VY94cofmVKG14SgVIyK4wPPAbffyyvaV6ika3nzySzVdzfMWYm+7yLIE9LBH1ewhdfaRDU="
        ...
        curl_setopt_array($curl, array(
            CURLOPT_URL => 'https://paymentreceiptuat.tvscredit.com/receipt/r1/hash104',
            CURLOPT_RETURNTRANSFER => true,
            CURLOPT_ENCODING => '',
            CURLOPT_MAXREDIRS => 10,
            CURLOPT_TIMEOUT => 0,
        ...
        $returnURL = $responseArray['returnURL'];
        echo $returnURL;
    }
...
',
    ...
    function instrument_DigitalNoc()
    {
        $agg = $_POST['ag_no'];
        load_curl();
        ...
        curl_setopt_array($curl, array(
            CURLOPT_URL => 'https://digitalsanweluat.tvscredit.com/TVSCSLetterGen/web/index.php/api/generate_noc',
            CURLOPT_RETURNTRANSFER => true,
            CURLOPT_ENCODING => '',
            CURLOPT_MAXREDIRS => 10,
            CURLOPT_TIMEOUT => 0,
...
',
        ...
        if ($a->responsemsg == "NOC Validity Expired") {
            echo "NOC Validity Expired";
        } else if ($a->responsemsg == "Success") {
            $res = str_replace(array('{', '}', ','), ' ', $response);
            $exp = explode(":", $res);
            // var_dump($exp);
            $string = $exp[3];
            ...
            echo $string;
        } else if ($a->responsemsg == "Hold Marked - NOC generation not allowed") {
            echo "Hold Marked - NOC generation not allowed";
        } else if ($a->responsemsg == "NOC not Applicable") {
            echo "NOC not Applicable";
        } else {
            echo "api not generating pdf";
        }
    }


    function instrument_detailWelcomeLetterTL()
    {
        ...
        $document_value = $parsed_response['document'];

        echo $document_value;
        // echo json_decode($response);
        // $responseData = json_decode($response);
        // $documentValue = $responseData->document;
        // $responsecode = $responseData->responsecode;
        // echo base64_encode($response);

        // $pdfData = base64_encode($documentValue);

        // echo $pdfData;
        // if ($responsecode === 200) {.
        //   echo $base64PDF;
        // $base64PDF = base64_encode($documentValue);
        // 
        // } else {
        //     echo "no data found";
        // }
