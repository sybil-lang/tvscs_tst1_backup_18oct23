...
*/
   ...
   //        }
          ...
          function upload_document_enabler()
     {
        ...
        curl_setopt_array($curl, array(
          CURLOPT_URL => "https://dealerportalservicesuat.tvscredit.com/DealerDetails/GetPDDStatus",
          CURLOPT_RETURNTRANSFER => true,
          CURLOPT_ENCODING => "",
          CURLOPT_MAXREDIRS => 10,
          CURLOPT_TIMEOUT => 0,
     ...
     function statcheck()
     {
        ...
        $curl = curl_init();
          ...
          curl_setopt_array($curl, array(
          CURLOPT_URL => "https://dealerportalservicesuat.tvscredit.com/DealerDetails/GetPDDUploadStatus",
          CURLOPT_RETURNTRANSFER => true,
          CURLOPT_ENCODING => "",
          CURLOPT_MAXREDIRS => 10,
          CURLOPT_TIMEOUT => 0,
...
for($i=0;$i<$fcount;$i++)
{
  if ( isset( $_FILES['file'.$i.$div]['tmp_name'] ) and strlen( $_FILES['file'.$i.$div]['tmp_name'] ) ) {
                    ...
                    // $con->FileAttachments = new RNCPHP\FileAttachmentCommonArray();
                                ...
                                for($j=0;$j<4;$j++)
                                {
                                  for($f=0;$f<$count_attach;$f++)
                                  {
                                    ...
                                    {
                                    $id= $fattachArr[$f]->ID;
                                    $attachment[$type.$j."_".$agmt]="https://tvscs--tst1.custhelp.com/services/rest/connect/v1.3/contacts/".$con_id."/fileAttachments/".$id."?download";
                                ...
                                curl_setopt_array($curl, array(
                                CURLOPT_URL => "https://dealerportalservicesuat.tvscredit.com/DealerDetails/PDDImage",
                                CURLOPT_RETURNTRANSFER => true,
                                CURLOPT_ENCODING => "",
                                CURLOPT_MAXREDIRS => 10,
                                CURLOPT_TIMEOUT => 0,
    ...
    {   
        ...
        curl_setopt_array($curl, array(
          CURLOPT_URL => "https://dealerportalservicesuat.tvscredit.com/DealerDetails/GetDealerProfile",
          CURLOPT_RETURNTRANSFER => true,
          CURLOPT_ENCODING => "",
          CURLOPT_MAXREDIRS => 10,
          CURLOPT_TIMEOUT => 0,
