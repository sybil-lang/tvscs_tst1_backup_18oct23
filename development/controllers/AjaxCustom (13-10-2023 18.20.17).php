...
class AjaxCustom extends \RightNow\Controllers\Base
{
   ...
   "utm_campaign":""
    ...
    function rest_api_report()
    {
        ...
        // else if ($_REQUEST["filtering_val"] == "ndc_noc_status"){
        //     echo "<div class='form-group'><select id='i_detailms'><option value='0'>--Select--</option>";
        //     foreach ($response as $key => $result) {
        //         //	if(!empty($userData['agg_no']) && $userData['agg_no'] == $result['Agreement No']){
        //         //$sel = "selected";
        //         //$flag = true;
...
curl_setopt_array($curl, array(
  CURLOPT_URL => 'https://appsuatoci.tvscredit.com/tvs/api/knox?data={%22name%22%3A%22getKnoxAndDcUnlockOfflinePin%22%2C%22accessKey%22%3A%225dfd585c8f4264333a6baa3df9afc3fd454bd1c5042533abaf865454caa8abcsk%22%2C%22agmtNumber%22%3A%22'.$ag_no.'%22%2C%22challenge%22%3A%22'.$pass.'%22}',
  CURLOPT_RETURNTRANSFER => true,
  CURLOPT_ENCODING => '',
  CURLOPT_MAXREDIRS => 10,
  CURLOPT_TIMEOUT => 0,
...
',
    ...
    function noclivecheck_customer()
    {
        ...
        //Commented the below code for NOC APIs update with new Java Apis
        // $curl = curl_init();
        ...
        curl_setopt_array($curl, array(
            CURLOPT_URL => 'https://ivrchatbotrestuatoci.tvscredit.com/IVRCHATBOT/IVR/LoanDetails/NOCTicketRaise',
            CURLOPT_RETURNTRANSFER => true,
            CURLOPT_ENCODING => '',
            CURLOPT_MAXREDIRS => 10,
            CURLOPT_TIMEOUT => 0,
...
',
    ...
    function instrument_DigitalNoc()
    {
        ...
        //     curl_setopt_array($curl, array(
        //         CURLOPT_URL => 'https://digitalsanwel.tvscredit.com/TVSCSLetterGen/web/index.php/api/generate_noc',
        //         CURLOPT_RETURNTRANSFER => true,
        //         CURLOPT_ENCODING => '',
        //         CURLOPT_MAXREDIRS => 10,
        //         CURLOPT_TIMEOUT => 0,
