...
class AjaxCustom extends \RightNow\Controllers\Base
{
    ...
    function rest_api_call()
    {
        ...
        $ch = curl_init("https://tvscscrmoci.tvscredit.com/tvscrmlosws/rest/GetTVSDetails/giveOutput?hidInputObj={methodName:" . $_REQUEST['method'] . ",agreementNo:" . $_REQUEST['ag_no'] . "}");
        ...
        if ($_REQUEST['method'] == "getCustomerDetails") {
            ...
            //print_r($result);
            $html_outout = '<div class="form-2">
                                    <h1><span class="log-in">Charges here</span></h1>';
    ...
    function rest_api_call_drop()
    {
        ...
        if ($_REQUEST["method_val"] == "getMandateStatuses") {
            ...
            curl_setopt_array(
                $curl,
                array(
                    CURLOPT_URL => "https://tvscscrmserviceoci.tvscredit.com/CRMService.svc/MandateAgreementflag",
                    CURLOPT_RETURNTRANSFER => true,
                    CURLOPT_ENCODING => "",
                    CURLOPT_MAXREDIRS => 10,
                    CURLOPT_TIMEOUT => 0,
            ...
            curl_setopt_array(
                $curl,
                array(
                    CURLOPT_URL => "https://pullrcapioci.tvscredit.com/api/PullRC/GetRCImagedetails",
                    CURLOPT_RETURNTRANSFER => true,
                    CURLOPT_ENCODING => "",
                    CURLOPT_MAXREDIRS => 10,
                    CURLOPT_TIMEOUT => 0,
            ...
            if ($_REQUEST['method_val'] == "getInsuranceDetails") {
                ...
                $ch = curl_init("https://tvscscrmoci.tvscredit.com/tvscrmlosws/rest/GetTVSDetails/giveOutput?hidInputObj={methodName:" . $_REQUEST['method_val'] . ",agreementNo:" . $_REQUEST['ag_no'] . "}");
            } else {
                ...
                $ch = curl_init("https://tvscscrmoci.tvscredit.com/tvscrmlosws/rest/GetTVSDetails/giveOutput?hidInputObj={methodName:getLoanStatusandOtherDetails,agreementNo:" . $_REQUEST['ag_no'] . "}");
            }
            ...
            if ($_REQUEST['method_val'] == 'initialloanamount') {
                ...
                if ($data_decode->error_desc == "No Data Found") {
                    ...
                    if ($flag_foreclosure_letter) {
                        $url_for = "https://rmsnewoci.tvscredit.com/rms/Jasper?AGRNO=" . $_REQUEST['ag_no'] . "&DATE=" . date('d/m/Y') . "&report=Foreclosure_Print";
                    } else {
                        $url_for = '';
                    }
                    //$soa_for = "https://tvscscrmuat.tvscredit.com:8180/tvscrmlosws/rest/GetTVSDetails/giveSOAPDF?agreementNo=".$_REQUEST['ag_no'];

                    $soa_for = "https://tvscscrmoci.tvscredit.com/tvscrmlosws/rest/GetTVSDetails/giveSOAPDF?agreementNo=" . $_REQUEST['ag_no'];
                    $soa_for = "";
...
?>
                            ...
                            if ($(this).val() != '0') {
                                ...
                                $.post("/cc/AjaxCustom/rest_api_call_drop2", {
                                    ...
                                    .done(function(data) {
                                        ...
                                        $('.text12').html(
                                            "<p><a href='https://tvscscrmserviceoci.tvscredit.com/CRMService.svc/Blank_mandate/" +
                                            id +
                                        ...
                                        $('.text2').html("");
                                        // var url_to = "https://rmsnewoci.tvscredit.com/rms/Jasper?AGRNO=TN3000CD0006055&report=NOC_FOR_CDPORTFOLIO.jrxml";//"https://rmsnewoci.tvscredit.com/rms/Jasper?AGRNO="+id+"&report=NOC_FOR_CDPORTFOLIO.jrxml"; https://tvscscrmservice.tvscredit.com/CRMService.svc/Blank_mandate/TN3000TW00426
                                        //https://rmsnewoci.tvscredit.com/rms/Jasper?AGRNO=TN3000TW00426&report=NOC_FOR_CDPORTFOLIO.jrxml ;;;https://tvscscrmservice.tvscredit.com/CRMService.svc/GetFilledForm_ECS/TN3000TW00426 earlier -> https://tvscscrmuatservice.tvscredit.com/CRMService.svc/GetFilledForm_ECS
                                        $('#dwnbtn').html("<a href='https://rmsnewoci.tvscredit.com/rms/Jasper?AGRNO=" +
                                            id +
                                        ...
                                        $('#filledbtn').html(
                                            "<a href='https://tvscscrmserviceoci.tvscredit.com/CRMService.svc/GetFilledForm_ECS/" +
                                            id +
    ...
    function makepaymentapi_button()
    {
        ...
        curl_setopt_array(
            $curl,
            array(
                CURLOPT_URL => 'https://pgoci.tvscredit.com/Customer/FetchCustomer',
                CURLOPT_RETURNTRANSFER => true,
                CURLOPT_ENCODING => '',
                CURLOPT_MAXREDIRS => 10,
                CURLOPT_TIMEOUT => 0,
    ...
    function makepaymentapi()
    {
        ...
        curl_setopt_array(
            $curl,
            array(
                CURLOPT_URL => 'https://pgoci.tvscredit.com//Customer/FetchChargeWithSplit',
                CURLOPT_RETURNTRANSFER => true,
                CURLOPT_ENCODING => '',
                CURLOPT_MAXREDIRS => 10,
                CURLOPT_TIMEOUT => 0,
...
?>
                            ...
                            $.post("/cc/AjaxCustom/InsuranceRenewalPolicy", {
                                ...
                                .done(function(data) {
                                    ...
                                    if (data == "true") {
                                        $("#showresult_instrument").css("display", "block");
                                        // $("#showresult_instrument").hide();																 
                                        var url = 'https://customeroperationapioci.tvscredit.com/InsuranceRenewal/InsurancecopyRenewalDocuments?AgreementNo=' + id //id
                        ...
                        if (id != "--Select--" && id.includes("AP3019") || id.includes("AP3020") || id.includes("AP3075")) {
                            ...
                            $.post("/cc/AjaxCustom/rest_api_call_drop", {
                                ...
                                .done(function(data) {
                                    ...
                                    $('.text12').html("<p><a href='https://tvscscrmserviceoci.tvscredit.com/CRMService.svc/Blank_mandate/" + id + "' class='live-cust'  style='display: none;' download><img src='/euf/assets/images/pdficon.png' width='100' height='110'></a><br><strong style='color:#003c7d;'>Blank Mandate:</strong> Please download the blank mandate. Fill the appropriate bank details as required, sign it as per your bank records and send it to our address: TVS Credit Services, 2nd Floor, Bristol Tower, 10 South Phase, Thiruvika Industrial Estate, Guindy Chennai-600 032</p>");
                                    $('.text2').html("");
                                    ...
                                    $('#dwnbtn').html("<a href='https://rmsnew.tvscreditoci.com/rms/Jasper?AGRNO=" + id + "&report=NOC_FOR_CDPORTFOLIO.pdf' class='no-due' id='no-due' target='_blank' download><img src='/euf/assets/images/pdficon.png' width='100' height='110'></a>");
                                    $('#filledbtn').html("<a href='https://tvscscrmserviceoci.tvscredit.com/CRMService.svc/GetFilledForm_ECS/" + id + "' class='req-cust' id='req-cust' target='_blank' download><img src='/euf/assets/images/pdficon.png' width='100' height='110'></a>");
    ...
    function file_attatch()
    {
        ...
        // exit;
        // print_r($file);s
        // $incident = RNCPHP\Incident::fetch("220927-000025");
        // //230207-00004
    ...
    */
    ...
    function edoc()
    {
        ...
        curl_setopt_array(
            $curl,
            array(
                CURLOPT_URL => 'https://customeroperationapioci.tvscredit.com/Customer/FileDownload',
                CURLOPT_RETURNTRANSFER => true,
                CURLOPT_ENCODING => '',
                CURLOPT_MAXREDIRS => 10,
                CURLOPT_TIMEOUT => 0,
    ...
    function cdndc()
    {
        ...
        //insurance 77
        $url = "https://rmsnewoci.tvscredit.com/rms/Jasper?AGRNO=" . $agg[1] . "&report=NOC_FOR_CDPORTFOLIO.pdf";
        $msg = "";
        load_curl();
        // $curl = curl_init();
    ...
    function soa_download_for_customer()
    {
        ...
        curl_setopt_array(
            $curl,
            array(
                CURLOPT_URL => 'https://tvscscrmoci.tvscredit.com/tvscrmlosws/rest/GetTVSDetails/callUserAuthenticate',
                CURLOPT_RETURNTRANSFER => true,
                CURLOPT_ENCODING => '',
                CURLOPT_MAXREDIRS => 10,
                CURLOPT_TIMEOUT => 0,
    ...
    "soaGeneratedUserid":"' . $mobile . '"
        ...
        if ($data->root->Result->Status == 2) {
            ...
            curl_setopt_array(
                $curl2,
                array(
                    CURLOPT_URL => 'https://tvscscrmoci.tvscredit.com/tvscrmlosws/rest/GetTVSDetails/givePostSOAPDFJSON',
                    CURLOPT_RETURNTRANSFER => true,
                    CURLOPT_ENCODING => '',
                    CURLOPT_MAXREDIRS => 10,
                    CURLOPT_TIMEOUT => 0,
    ...
    function paperlessnoc()
    {
        ...
        curl_setopt_array(
            $curl,
            array(
                CURLOPT_URL => 'https://tvsrmskycoci.tvscredit.com/tvsrmskycws/rest/kyc/createsess',
                CURLOPT_RETURNTRANSFER => true,
                CURLOPT_ENCODING => '',
                CURLOPT_MAXREDIRS => 10,
                CURLOPT_TIMEOUT => 0,
        ...
        if (strpos($response, 'errorCode=0000') == false) {
            ...
            curl_setopt_array(
                $curl2,
                array(
                    CURLOPT_URL => 'https://tvsrmskycoci.tvscredit.com/tvsrmskycws/rest/kyc/paperlessnoc',
                    CURLOPT_RETURNTRANSFER => true,
                    CURLOPT_ENCODING => '',
                    CURLOPT_MAXREDIRS => 10,
                    CURLOPT_TIMEOUT => 0,
    ...
    function prefilled_mandate()
    {
        ...
        curl_setopt_array($curl, array(
            CURLOPT_URL => 'https://ivrchatbotrestoci.tvscredit.com/IVRCHATBOT/PACard/pdfreader?agreementNo=' . $ag,
            CURLOPT_RETURNTRANSFER => true,
            CURLOPT_ENCODING => '',
            CURLOPT_MAXREDIRS => 10,
            CURLOPT_TIMEOUT => 0,
    ...
    function employee_noc()
    {
        ...
        if (substr($agg_no, 0, 6) === "AP3019" || substr($agg_no, 0, 6) === "AP3020" || substr($agg_no, 0, 6) === "AP3075") {
            ...
            curl_setopt_array($curl, array(
                CURLOPT_URL => 'https://tvsrmskycoci.tvscredit.com/tvsrmskycws/rest/kyc/otherportnoc',
                CURLOPT_RETURNTRANSFER => true,
                CURLOPT_ENCODING => '',
                CURLOPT_MAXREDIRS => 10,
                CURLOPT_TIMEOUT => 0,
    ...
    function GetTokenListApiForTmsDashboard()
    {
        ...
        curl_setopt_array(
            $curl,
            array(
                CURLOPT_URL => 'https://dealerportalservices.tvscredit.com/tmsoci/api/tmsapi/GetTokenList',
                CURLOPT_RETURNTRANSFER => true,
                CURLOPT_ENCODING => '',
                CURLOPT_MAXREDIRS => 10,
                CURLOPT_TIMEOUT => 0,
...
',
    ...
    function GetTokenCountByStatusForReport()
    {
        ...
        curl_setopt_array(
            $curl,
            array(
                CURLOPT_URL => 'https://dealerportalservices.tvscredit.com/tmsoci/api/tmsapi/GetTokenCountByStatus',
                CURLOPT_RETURNTRANSFER => true,
                CURLOPT_ENCODING => '',
                CURLOPT_MAXREDIRS => 10,
                CURLOPT_TIMEOUT => 0,
...
',
    ...
    function GetSerachByCategory()
    {
        ...
        curl_setopt_array(
            $curl,
            array(
                CURLOPT_URL => 'https://dealerportalservices.tvscredit.com/tmsoci/api/tmsapi/GetTokenSearchByCategory',
                CURLOPT_RETURNTRANSFER => true,
                CURLOPT_ENCODING => '',
                CURLOPT_MAXREDIRS => 10,
                CURLOPT_TIMEOUT => 0,
    ...
    function GetTokenDetails()
    {
        ...
        curl_setopt_array(
            $curl,
            array(
                CURLOPT_URL => 'https://dealerportalservices.tvscredit.com/tmsoci/api/tmsapi/GetTokenDetails',
                CURLOPT_RETURNTRANSFER => true,
                CURLOPT_ENCODING => '',
                CURLOPT_MAXREDIRS => 10,
                CURLOPT_TIMEOUT => 0,
    ...
    function UpdateTokenStatus()
    {
        ...
        curl_setopt_array(
            $curl,
            array(
                CURLOPT_URL => 'https://dealerportalservices.tvscredit.com/tmsoci/api/tmsapi/UpdateTokenStatus',
                CURLOPT_RETURNTRANSFER => true,
                CURLOPT_ENCODING => '',
                CURLOPT_MAXREDIRS => 10,
                CURLOPT_TIMEOUT => 0,
    ...
    function CustomerOneView()
    {
        ...
        curl_setopt_array($curl, array(
            CURLOPT_URL => 'https://crmuat.tvscredit.com/oneview/user/getToken',
            CURLOPT_RETURNTRANSFER => true,
            CURLOPT_ENCODING => '',
            CURLOPT_MAXREDIRS => 10,
            CURLOPT_TIMEOUT => 0,
    ...
    function InsertLMSDataPL()
    {
        ...
        try {
            ...
            curl_setopt_array(
                $curl,
                array(
                    CURLOPT_URL => 'https://lmsrestserviceoci.tvscredit.com/LMSLEADS/LMS/InsertLMSData',
                    CURLOPT_RETURNTRANSFER => true,
                    CURLOPT_ENCODING => '',
                    CURLOPT_MAXREDIRS => 10,
                    CURLOPT_TIMEOUT => 0,
   ...
   "utm_campaign":""
    ...
    function InsuranceNotification()
    {
        ...
        curl_setopt_array(
            $curl,
            array(
                CURLOPT_URL => 'https://customeroperationapioci.tvscredit.com/ChatBotNew/InsuranceNotification',
                CURLOPT_RETURNTRANSFER => true,
                CURLOPT_ENCODING => '',
                CURLOPT_MAXREDIRS => 10,
                CURLOPT_TIMEOUT => 0,
    ...
    function BounceNotification()
    {
        ...
        curl_setopt_array(
            $curl,
            array(
                CURLOPT_URL => 'https://customeroperationapioci.tvscredit.com/ChatBotNew/BounceNotification',
                CURLOPT_RETURNTRANSFER => true,
                CURLOPT_ENCODING => '',
                CURLOPT_MAXREDIRS => 10,
                CURLOPT_TIMEOUT => 0,
    ...
    function RC_PendingNotification()
    {
        ...
        curl_setopt_array(
            $curl,
            array(
                CURLOPT_URL => 'https://ivrchatbotrestoci.tvscredit.com/IVRCHATBOT/PACard/getNotification?agreementNo=' . $ag . '',
                CURLOPT_RETURNTRANSFER => true,
                CURLOPT_ENCODING => '',
                CURLOPT_MAXREDIRS => 10,
                CURLOPT_TIMEOUT => 0,
    ...
    function MandateRejectNotification()
    {
        ...
        curl_setopt_array(
            $curl,
            array(
                CURLOPT_URL => 'https://customeroperationapioci.tvscredit.com/ChatBotNew/MandateRejectNotification',
                CURLOPT_RETURNTRANSFER => true,
                CURLOPT_ENCODING => '',
                CURLOPT_MAXREDIRS => 10,
                CURLOPT_TIMEOUT => 0,
    ...
    function NOCPendingNotification()
    {
        ...
        curl_setopt_array(
            $curl,
            array(
                CURLOPT_URL => 'https://customeroperationapioci.tvscredit.com/ChatBotNew/NOCPendingNotification',
                CURLOPT_RETURNTRANSFER => true,
                CURLOPT_ENCODING => '',
                CURLOPT_MAXREDIRS => 10,
                CURLOPT_TIMEOUT => 0,
    ...
    function MandateSuccessNotification()
    {
        ...
        curl_setopt_array(
            $curl,
            array(
                CURLOPT_URL => 'https://customeroperationapioci.tvscredit.com/ChatBotNew/MandateSuccessNotification',
                CURLOPT_RETURNTRANSFER => true,
                CURLOPT_ENCODING => '',
                CURLOPT_MAXREDIRS => 10,
                CURLOPT_TIMEOUT => 0,
    ...
    function ClearedNotification()
    {
        ...
        curl_setopt_array(
            $curl,
            array(
                CURLOPT_URL => 'https://customeroperationapioci.tvscredit.com/ChatBotNew/ClearedNotification',
                CURLOPT_RETURNTRANSFER => true,
                CURLOPT_ENCODING => '',
                CURLOPT_MAXREDIRS => 10,
                CURLOPT_TIMEOUT => 0,
    ...
    function PNTNotification()
    {
        ...
        curl_setopt_array(
            $curl,
            array(
                CURLOPT_URL => 'https://customeroperationapioci.tvscredit.com/ChatBotNew/PNTNotification',
                CURLOPT_RETURNTRANSFER => true,
                CURLOPT_ENCODING => '',
                CURLOPT_MAXREDIRS => 10,
                CURLOPT_TIMEOUT => 0,
    ...
    function rcpullUpload()
    {
        ...
        curl_setopt_array(
            $curl,
            array(
                CURLOPT_URL => 'https://pullrcapioci.tvscredit.com/api/PullRC/MediaUpload',
                CURLOPT_RETURNTRANSFER => true,
                CURLOPT_ENCODING => '',
                CURLOPT_MAXREDIRS => 10,
                CURLOPT_TIMEOUT => 0,
    ...
    function nocdispatched()
    {
        ...
        curl_setopt_array(
            $curl,
            array(
                CURLOPT_URL => 'https://botinterfaceoci.tvscredit.com/WebService.asmx?op=RequestNOC_EXT',
                CURLOPT_RETURNTRANSFER => true,
                CURLOPT_ENCODING => '',
                CURLOPT_MAXREDIRS => 10,
                CURLOPT_TIMEOUT => 0,
    ...
    function CheckLoanEligibilityNOC()
    {
        ...
        curl_setopt_array(
            $curl,
            array(
                CURLOPT_URL => 'https://botinterfaceoci.tvscredit.com/WebService.asmx?op=CheckLoanEligibility',
                CURLOPT_RETURNTRANSFER => true,
                CURLOPT_ENCODING => '',
                CURLOPT_MAXREDIRS => 10,
                CURLOPT_TIMEOUT => 0,
    ...
    function instrument_detailRepaymentLetter()
    {
        ...
        //     $curl,
        //     array(
        //         CURLOPT_URL => 'https://digitalsanweluat.tvscredit.com/TVSCSLetterGen/web/index.php/api/generate_letter',
        //         CURLOPT_RETURNTRANSFER => true,
        //         CURLOPT_ENCODING => '',
        //         CURLOPT_MAXREDIRS => 10,
        //         CURLOPT_TIMEOUT => 0,
        ...
        //         CURLOPT_CUSTOMREQUEST => 'GET',
        //         CURLOPT_POSTFIELDS => '{
        // "accessToken": "969eb9bb9ceb91c26508f102539363f8",
        // "doctype": "WLETTER",
        // "entityid":"' . $agg . '"}',
        //         CURLOPT_HTTPHEADER => array(
        //             'Content-Type: application/json'
        ...
        curl_setopt_array(
            $curl,
            array(
                CURLOPT_URL => 'https://digitalsanweluat.tvscredit.com/TVSCSLetterGen/web/index.php/api/draft_requirement_letter',
                CURLOPT_RETURNTRANSFER => true,
                CURLOPT_ENCODING => '',
                CURLOPT_MAXREDIRS => 10,
                CURLOPT_TIMEOUT => 0,
...
',
    ...
    function sendForm()
    {
        ...
        try {
            ...
            if (!empty($_POST['category'])) {
                $incident->Category = RNCPHP\ServiceCategory::fetch($_POST['category']);
            }
            ...
            $incident->Threads[0]->EntryType = new RNCPHP\NamedIDOptList();
            $incident->Threads[0]->EntryType->ID = 4; // Used the ID here. See the Thread object for definition
            $incident->Threads[0]->Text = $_POST['question'];
    ...
    function cdmobileunlock()
    {
        ...
        curl_setopt_array($curl, array(
            CURLOPT_URL => 'https://appsoci.tvscredit.com/tvs/api/knox?data=%7B%22name%22:%22getKnoxAndDcUnlockOfflinePin%22,%22accessKey%22:%225dfd585c8f4264333a6baa3df9afc3fd454bd1c5042533abaf865454caa8abcsk%22,%22agmtNumber%22:%22' . $agg[1] . '1%22,%22challenge%22:%22' . $pass . '%22%7D',
            CURLOPT_RETURNTRANSFER => true,
            CURLOPT_ENCODING => '',
            CURLOPT_MAXREDIRS => 10,
            CURLOPT_TIMEOUT => 0,
    ...
    function outstanding_verification()
    {
        ...
        curl_setopt_array($curl, array(
            CURLOPT_URL => 'https://ivrchatbotrestoci.tvscredit.com/IVRCHATBOT/IVR/LoanDetails/LoanBalEnquiry',
            CURLOPT_RETURNTRANSFER => true,
            CURLOPT_ENCODING => '',
            CURLOPT_MAXREDIRS => 10,
            CURLOPT_TIMEOUT => 0,
        ...
        ',
            CURLOPT_HTTPHEADER => array(
                'Content-Type: application/json',
                'Authorization: Basic SVZSVVNSOklWUlVTUiQ=',
                'Cookie: JSESSIONID=ZigdN9Ou0Y9C5GWA71Nkw5VSH0y-o53NpKtbUWq5.csdcapps9'
            ),
        ));
